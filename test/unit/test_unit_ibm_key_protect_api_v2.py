...
class TestPutInstancePolicy:
    ...
    def test_put_instance_policy_all_params(self):
        ...
        instance_policy_allowed_network_policy_data_model['attributes'] = instance_policy_allowed_network_policy_data_attributes_model
        ...
        set_instance_policies_one_of_set_instance_policy_allowed_network_resources_item_model['policy_type'] = 'allowedNetwork'
        set_instance_policies_one_of_set_instance_policy_allowed_network_resources_item_model['policy_data'] = instance_policy_allowed_network_policy_data_model
        ...
        set_instance_policies_one_of_model['resources'] = [set_instance_policies_one_of_set_instance_policy_allowed_network_resources_item_model]
...
class TestModel_AllowedIPPortResource:
    ...
    def test_allowed_ip_port_resource_serialization(self):
        ...
        # Construct a model instance of AllowedIPPortResource by calling from_dict on the json representation
        allowed_ip_port_resource_model_dict = AllowedIPPortResource.from_dict(allowed_ip_port_resource_model_json).__dict__
...
class TestModel_CollectionMetadataListKeys:
    ...
    def test_collection_metadata_list_keys_serialization(self):
        ...
        collection_metadata_list_keys_model = CollectionMetadataListKeys.from_dict(collection_metadata_list_keys_model_json)
        assert collection_metadata_list_keys_model != False

        # Construct a model instance of CollectionMetadataListKeys by calling from_dict on the json representation
        collection_metadata_list_keys_model_dict = CollectionMetadataListKeys.from_dict(collection_metadata_list_keys_model_json).__dict__
...
class TestModel_CollectionMetadataWithTotalCount:
    ...
    def test_collection_metadata_with_total_count_serialization(self):
        ...
        collection_metadata_with_total_count_model_json['collectionType'] = 'application/vnd.ibm.kms.allowed_ip_metadata+json'
        ...
        collection_metadata_with_total_count_model = CollectionMetadataWithTotalCount.from_dict(collection_metadata_with_total_count_model_json)
        assert collection_metadata_with_total_count_model != False

        # Construct a model instance of CollectionMetadataWithTotalCount by calling from_dict on the json representation
        collection_metadata_with_total_count_model_dict = CollectionMetadataWithTotalCount.from_dict(collection_metadata_with_total_count_model_json).__dict__
        collection_metadata_with_total_count_model2 = CollectionMetadataWithTotalCount(**collection_metadata_with_total_count_model_dict)
...
class TestModel_CreateKMIPAdapterObject:
    ...
    def test_create_kmip_adapter_object_serialization(self):
        ...
        # Construct a model instance of CreateKMIPAdapterObject by calling from_dict on the json representation
        create_kmip_adapter_object_model_dict = CreateKMIPAdapterObject.from_dict(create_kmip_adapter_object_model_json).__dict__
...
class TestModel_CreateKMIPClientCertificateObject:
    ...
    def test_create_kmip_client_certificate_object_serialization(self):
        ...
        create_kmip_client_certificate_object_model = CreateKMIPClientCertificateObject.from_dict(create_kmip_client_certificate_object_model_json)
        assert create_kmip_client_certificate_object_model != False

        # Construct a model instance of CreateKMIPClientCertificateObject by calling from_dict on the json representation
        create_kmip_client_certificate_object_model_dict = CreateKMIPClientCertificateObject.from_dict(create_kmip_client_certificate_object_model_json).__dict__
        create_kmip_client_certificate_object_model2 = CreateKMIPClientCertificateObject(**create_kmip_client_certificate_object_model_dict)
...
class TestModel_DualAuthDeleteProperties:
    ...
    def test_dual_auth_delete_properties_serialization(self):
        ...
        # Construct a model instance of DualAuthDeleteProperties by calling from_dict on the json representation
        dual_auth_delete_properties_model_dict = DualAuthDeleteProperties.from_dict(dual_auth_delete_properties_model_json).__dict__
...
class TestModel_GetInstancePoliciesOneOfGetInstancePolicyAllowedNetworkResourcesItem:
    ...
    def test_get_instance_policies_one_of_get_instance_policy_allowed_network_resources_item_serialization(self):
        """
        ...
        get_instance_policies_one_of_get_instance_policy_allowed_network_resources_item_policy_data_attributes_model = {}  # GetInstancePoliciesOneOfGetInstancePolicyAllowedNetworkResourcesItemPolicyDataAttributes
        get_instance_policies_one_of_get_instance_policy_allowed_network_resources_item_policy_data_attributes_model['allowed_network'] = 'public-and-private'

        get_instance_policies_one_of_get_instance_policy_allowed_network_resources_item_policy_data_model = {}  # GetInstancePoliciesOneOfGetInstancePolicyAllowedNetworkResourcesItemPolicyData
        get_instance_policies_one_of_get_instance_policy_allowed_network_resources_item_policy_data_model['enabled'] = True
        get_instance_policies_one_of_get_instance_policy_allowed_network_resources_item_policy_data_model['attributes'] = get_instance_policies_one_of_get_instance_policy_allowed_network_resources_item_policy_data_attributes_model
        ...
        get_instance_policies_one_of_get_instance_policy_allowed_network_resources_item_model_json['policy_type'] = 'testString'
        get_instance_policies_one_of_get_instance_policy_allowed_network_resources_item_model_json['policy_data'] = get_instance_policies_one_of_get_instance_policy_allowed_network_resources_item_policy_data_model
        ...
        get_instance_policies_one_of_get_instance_policy_allowed_network_resources_item_model = GetInstancePoliciesOneOfGetInstancePolicyAllowedNetworkResourcesItem.from_dict(get_instance_policies_one_of_get_instance_policy_allowed_network_resources_item_model_json)
        assert get_instance_policies_one_of_get_instance_policy_allowed_network_resources_item_model != False

        # Construct a model instance of GetInstancePoliciesOneOfGetInstancePolicyAllowedNetworkResourcesItem by calling from_dict on the json representation
        get_instance_policies_one_of_get_instance_policy_allowed_network_resources_item_model_dict = GetInstancePoliciesOneOfGetInstancePolicyAllowedNetworkResourcesItem.from_dict(get_instance_policies_one_of_get_instance_policy_allowed_network_resources_item_model_json).__dict__
        get_instance_policies_one_of_get_instance_policy_allowed_network_resources_item_model2 = GetInstancePoliciesOneOfGetInstancePolicyAllowedNetworkResourcesItem(**get_instance_policies_one_of_get_instance_policy_allowed_network_resources_item_model_dict)

        # Verify the model instances are equivalent
        assert get_instance_policies_one_of_get_instance_policy_allowed_network_resources_item_model == get_instance_policies_one_of_get_instance_policy_allowed_network_resources_item_model2

        # Convert model instance back to dict and verify no loss of data
        get_instance_policies_one_of_get_instance_policy_allowed_network_resources_item_model_json2 = get_instance_policies_one_of_get_instance_policy_allowed_network_resources_item_model.to_dict()
        assert get_instance_policies_one_of_get_instance_policy_allowed_network_resources_item_model_json2 == get_instance_policies_one_of_get_instance_policy_allowed_network_resources_item_model_json
...
class TestModel_GetInstancePoliciesOneOfGetInstancePolicyAllowedNetworkResourcesItemPolicyData:
    ...
    def test_get_instance_policies_one_of_get_instance_policy_allowed_network_resources_item_policy_data_serialization(self):
        """
        ...
        get_instance_policies_one_of_get_instance_policy_allowed_network_resources_item_policy_data_model_json['enabled'] = True
        get_instance_policies_one_of_get_instance_policy_allowed_network_resources_item_policy_data_model_json['attributes'] = get_instance_policies_one_of_get_instance_policy_allowed_network_resources_item_policy_data_attributes_model
        ...
        get_instance_policies_one_of_get_instance_policy_allowed_network_resources_item_policy_data_model = GetInstancePoliciesOneOfGetInstancePolicyAllowedNetworkResourcesItemPolicyData.from_dict(get_instance_policies_one_of_get_instance_policy_allowed_network_resources_item_policy_data_model_json)
        assert get_instance_policies_one_of_get_instance_policy_allowed_network_resources_item_policy_data_model != False

        # Construct a model instance of GetInstancePoliciesOneOfGetInstancePolicyAllowedNetworkResourcesItemPolicyData by calling from_dict on the json representation
        get_instance_policies_one_of_get_instance_policy_allowed_network_resources_item_policy_data_model_dict = GetInstancePoliciesOneOfGetInstancePolicyAllowedNetworkResourcesItemPolicyData.from_dict(get_instance_policies_one_of_get_instance_policy_allowed_network_resources_item_policy_data_model_json).__dict__
        get_instance_policies_one_of_get_instance_policy_allowed_network_resources_item_policy_data_model2 = GetInstancePoliciesOneOfGetInstancePolicyAllowedNetworkResourcesItemPolicyData(**get_instance_policies_one_of_get_instance_policy_allowed_network_resources_item_policy_data_model_dict)

        # Verify the model instances are equivalent
        assert get_instance_policies_one_of_get_instance_policy_allowed_network_resources_item_policy_data_model == get_instance_policies_one_of_get_instance_policy_allowed_network_resources_item_policy_data_model2

        # Convert model instance back to dict and verify no loss of data
        get_instance_policies_one_of_get_instance_policy_allowed_network_resources_item_policy_data_model_json2 = get_instance_policies_one_of_get_instance_policy_allowed_network_resources_item_policy_data_model.to_dict()
        assert get_instance_policies_one_of_get_instance_policy_allowed_network_resources_item_policy_data_model_json2 == get_instance_policies_one_of_get_instance_policy_allowed_network_resources_item_policy_data_model_json
...
class TestModel_GetInstancePoliciesOneOfGetInstancePolicyAllowedNetworkResourcesItemPolicyDataAttributes:
    ...
    def test_get_instance_policies_one_of_get_instance_policy_allowed_network_resources_item_policy_data_attributes_serialization(self):
        """
        ...
        get_instance_policies_one_of_get_instance_policy_allowed_network_resources_item_policy_data_attributes_model_json['allowed_network'] = 'public-and-private'
        ...
        get_instance_policies_one_of_get_instance_policy_allowed_network_resources_item_policy_data_attributes_model = GetInstancePoliciesOneOfGetInstancePolicyAllowedNetworkResourcesItemPolicyDataAttributes.from_dict(get_instance_policies_one_of_get_instance_policy_allowed_network_resources_item_policy_data_attributes_model_json)
        assert get_instance_policies_one_of_get_instance_policy_allowed_network_resources_item_policy_data_attributes_model != False

        # Construct a model instance of GetInstancePoliciesOneOfGetInstancePolicyAllowedNetworkResourcesItemPolicyDataAttributes by calling from_dict on the json representation
        get_instance_policies_one_of_get_instance_policy_allowed_network_resources_item_policy_data_attributes_model_dict = GetInstancePoliciesOneOfGetInstancePolicyAllowedNetworkResourcesItemPolicyDataAttributes.from_dict(get_instance_policies_one_of_get_instance_policy_allowed_network_resources_item_policy_data_attributes_model_json).__dict__
        ...
        # Verify the model instances are equivalent
        assert get_instance_policies_one_of_get_instance_policy_allowed_network_resources_item_policy_data_attributes_model == get_instance_policies_one_of_get_instance_policy_allowed_network_resources_item_policy_data_attributes_model2

        # Convert model instance back to dict and verify no loss of data
        get_instance_policies_one_of_get_instance_policy_allowed_network_resources_item_policy_data_attributes_model_json2 = get_instance_policies_one_of_get_instance_policy_allowed_network_resources_item_policy_data_attributes_model.to_dict()
        assert get_instance_policies_one_of_get_instance_policy_allowed_network_resources_item_policy_data_attributes_model_json2 == get_instance_policies_one_of_get_instance_policy_allowed_network_resources_item_policy_data_attributes_model_json
...
class TestModel_GetInstancePoliciesOneOfGetInstancePolicyKeyCreateImportAccessResourcesItem:
    ...
    def test_get_instance_policies_one_of_get_instance_policy_key_create_import_access_resources_item_serialization(self):
        """
        ...
        get_instance_policies_one_of_get_instance_policy_key_create_import_access_resources_item_policy_data_attributes_model = {}  # GetInstancePoliciesOneOfGetInstancePolicyKeyCreateImportAccessResourcesItemPolicyDataAttributes
        get_instance_policies_one_of_get_instance_policy_key_create_import_access_resources_item_policy_data_attributes_model['create_root_key'] = True
        get_instance_policies_one_of_get_instance_policy_key_create_import_access_resources_item_policy_data_attributes_model['create_standard_key'] = True
        get_instance_policies_one_of_get_instance_policy_key_create_import_access_resources_item_policy_data_attributes_model['import_root_key'] = True
        get_instance_policies_one_of_get_instance_policy_key_create_import_access_resources_item_policy_data_attributes_model['import_standard_key'] = True
        get_instance_policies_one_of_get_instance_policy_key_create_import_access_resources_item_policy_data_attributes_model['enforce_token'] = True

        get_instance_policies_one_of_get_instance_policy_key_create_import_access_resources_item_policy_data_model = {}  # GetInstancePoliciesOneOfGetInstancePolicyKeyCreateImportAccessResourcesItemPolicyData
        get_instance_policies_one_of_get_instance_policy_key_create_import_access_resources_item_policy_data_model['enabled'] = True
        get_instance_policies_one_of_get_instance_policy_key_create_import_access_resources_item_policy_data_model['attributes'] = get_instance_policies_one_of_get_instance_policy_key_create_import_access_resources_item_policy_data_attributes_model
        ...
        get_instance_policies_one_of_get_instance_policy_key_create_import_access_resources_item_model_json['policy_type'] = 'testString'
        get_instance_policies_one_of_get_instance_policy_key_create_import_access_resources_item_model_json['policy_data'] = get_instance_policies_one_of_get_instance_policy_key_create_import_access_resources_item_policy_data_model
        ...
        get_instance_policies_one_of_get_instance_policy_key_create_import_access_resources_item_model = GetInstancePoliciesOneOfGetInstancePolicyKeyCreateImportAccessResourcesItem.from_dict(get_instance_policies_one_of_get_instance_policy_key_create_import_access_resources_item_model_json)
        assert get_instance_policies_one_of_get_instance_policy_key_create_import_access_resources_item_model != False

        # Construct a model instance of GetInstancePoliciesOneOfGetInstancePolicyKeyCreateImportAccessResourcesItem by calling from_dict on the json representation
        get_instance_policies_one_of_get_instance_policy_key_create_import_access_resources_item_model_dict = GetInstancePoliciesOneOfGetInstancePolicyKeyCreateImportAccessResourcesItem.from_dict(get_instance_policies_one_of_get_instance_policy_key_create_import_access_resources_item_model_json).__dict__
        get_instance_policies_one_of_get_instance_policy_key_create_import_access_resources_item_model2 = GetInstancePoliciesOneOfGetInstancePolicyKeyCreateImportAccessResourcesItem(**get_instance_policies_one_of_get_instance_policy_key_create_import_access_resources_item_model_dict)

        # Verify the model instances are equivalent
        assert get_instance_policies_one_of_get_instance_policy_key_create_import_access_resources_item_model == get_instance_policies_one_of_get_instance_policy_key_create_import_access_resources_item_model2

        # Convert model instance back to dict and verify no loss of data
        get_instance_policies_one_of_get_instance_policy_key_create_import_access_resources_item_model_json2 = get_instance_policies_one_of_get_instance_policy_key_create_import_access_resources_item_model.to_dict()
        assert get_instance_policies_one_of_get_instance_policy_key_create_import_access_resources_item_model_json2 == get_instance_policies_one_of_get_instance_policy_key_create_import_access_resources_item_model_json
...
class TestModel_GetInstancePoliciesOneOfGetInstancePolicyKeyCreateImportAccessResourcesItemPolicyData:
    ...
    def test_get_instance_policies_one_of_get_instance_policy_key_create_import_access_resources_item_policy_data_serialization(self):
        """
        ...
        get_instance_policies_one_of_get_instance_policy_key_create_import_access_resources_item_policy_data_model_json['enabled'] = True
        get_instance_policies_one_of_get_instance_policy_key_create_import_access_resources_item_policy_data_model_json['attributes'] = get_instance_policies_one_of_get_instance_policy_key_create_import_access_resources_item_policy_data_attributes_model
        ...
        get_instance_policies_one_of_get_instance_policy_key_create_import_access_resources_item_policy_data_model = GetInstancePoliciesOneOfGetInstancePolicyKeyCreateImportAccessResourcesItemPolicyData.from_dict(get_instance_policies_one_of_get_instance_policy_key_create_import_access_resources_item_policy_data_model_json)
        assert get_instance_policies_one_of_get_instance_policy_key_create_import_access_resources_item_policy_data_model != False

        # Construct a model instance of GetInstancePoliciesOneOfGetInstancePolicyKeyCreateImportAccessResourcesItemPolicyData by calling from_dict on the json representation
        get_instance_policies_one_of_get_instance_policy_key_create_import_access_resources_item_policy_data_model_dict = GetInstancePoliciesOneOfGetInstancePolicyKeyCreateImportAccessResourcesItemPolicyData.from_dict(get_instance_policies_one_of_get_instance_policy_key_create_import_access_resources_item_policy_data_model_json).__dict__
        get_instance_policies_one_of_get_instance_policy_key_create_import_access_resources_item_policy_data_model2 = GetInstancePoliciesOneOfGetInstancePolicyKeyCreateImportAccessResourcesItemPolicyData(**get_instance_policies_one_of_get_instance_policy_key_create_import_access_resources_item_policy_data_model_dict)

        # Verify the model instances are equivalent
        assert get_instance_policies_one_of_get_instance_policy_key_create_import_access_resources_item_policy_data_model == get_instance_policies_one_of_get_instance_policy_key_create_import_access_resources_item_policy_data_model2

        # Convert model instance back to dict and verify no loss of data
        get_instance_policies_one_of_get_instance_policy_key_create_import_access_resources_item_policy_data_model_json2 = get_instance_policies_one_of_get_instance_policy_key_create_import_access_resources_item_policy_data_model.to_dict()
        assert get_instance_policies_one_of_get_instance_policy_key_create_import_access_resources_item_policy_data_model_json2 == get_instance_policies_one_of_get_instance_policy_key_create_import_access_resources_item_policy_data_model_json
...
class TestModel_GetInstancePoliciesOneOfGetInstancePolicyKeyCreateImportAccessResourcesItemPolicyDataAttributes:
    ...
    def test_get_instance_policies_one_of_get_instance_policy_key_create_import_access_resources_item_policy_data_attributes_serialization(self):
        """
        ...
        get_instance_policies_one_of_get_instance_policy_key_create_import_access_resources_item_policy_data_attributes_model_json['create_root_key'] = True
        get_instance_policies_one_of_get_instance_policy_key_create_import_access_resources_item_policy_data_attributes_model_json['create_standard_key'] = True
        get_instance_policies_one_of_get_instance_policy_key_create_import_access_resources_item_policy_data_attributes_model_json['import_root_key'] = True
        get_instance_policies_one_of_get_instance_policy_key_create_import_access_resources_item_policy_data_attributes_model_json['import_standard_key'] = True
        get_instance_policies_one_of_get_instance_policy_key_create_import_access_resources_item_policy_data_attributes_model_json['enforce_token'] = True
        ...
        get_instance_policies_one_of_get_instance_policy_key_create_import_access_resources_item_policy_data_attributes_model = GetInstancePoliciesOneOfGetInstancePolicyKeyCreateImportAccessResourcesItemPolicyDataAttributes.from_dict(get_instance_policies_one_of_get_instance_policy_key_create_import_access_resources_item_policy_data_attributes_model_json)
        assert get_instance_policies_one_of_get_instance_policy_key_create_import_access_resources_item_policy_data_attributes_model != False

        # Construct a model instance of GetInstancePoliciesOneOfGetInstancePolicyKeyCreateImportAccessResourcesItemPolicyDataAttributes by calling from_dict on the json representation
        get_instance_policies_one_of_get_instance_policy_key_create_import_access_resources_item_policy_data_attributes_model_dict = GetInstancePoliciesOneOfGetInstancePolicyKeyCreateImportAccessResourcesItemPolicyDataAttributes.from_dict(get_instance_policies_one_of_get_instance_policy_key_create_import_access_resources_item_policy_data_attributes_model_json).__dict__
        ...
        # Verify the model instances are equivalent
        assert get_instance_policies_one_of_get_instance_policy_key_create_import_access_resources_item_policy_data_attributes_model == get_instance_policies_one_of_get_instance_policy_key_create_import_access_resources_item_policy_data_attributes_model2

        # Convert model instance back to dict and verify no loss of data
        get_instance_policies_one_of_get_instance_policy_key_create_import_access_resources_item_policy_data_attributes_model_json2 = get_instance_policies_one_of_get_instance_policy_key_create_import_access_resources_item_policy_data_attributes_model.to_dict()
        assert get_instance_policies_one_of_get_instance_policy_key_create_import_access_resources_item_policy_data_attributes_model_json2 == get_instance_policies_one_of_get_instance_policy_key_create_import_access_resources_item_policy_data_attributes_model_json
...
class TestModel_GetInstancePolicyAllowedIPResourcesItem:
    ...
    def test_get_instance_policy_allowed_ip_resources_item_serialization(self):
        ...
        get_instance_policy_allowed_ip_resources_item_policy_data_attributes_model = {}  # GetInstancePolicyAllowedIPResourcesItemPolicyDataAttributes
        get_instance_policy_allowed_ip_resources_item_policy_data_attributes_model['allowed_ip'] = ['10.1.0.0/32', '10.0.0.0/24', '192.0.2.0/32', '198.51.100.0/24', '2001:db8::/60']

        get_instance_policy_allowed_ip_resources_item_policy_data_model = {}  # GetInstancePolicyAllowedIPResourcesItemPolicyData
        get_instance_policy_allowed_ip_resources_item_policy_data_model['enabled'] = True
        get_instance_policy_allowed_ip_resources_item_policy_data_model['attributes'] = get_instance_policy_allowed_ip_resources_item_policy_data_attributes_model
        ...
        get_instance_policy_allowed_ip_resources_item_model_json['policy_data'] = get_instance_policy_allowed_ip_resources_item_policy_data_model

        # Construct a model instance of GetInstancePolicyAllowedIPResourcesItem by calling from_dict on the json representation
        get_instance_policy_allowed_ip_resources_item_model = GetInstancePolicyAllowedIPResourcesItem.from_dict(get_instance_policy_allowed_ip_resources_item_model_json)
        assert get_instance_policy_allowed_ip_resources_item_model != False

        # Construct a model instance of GetInstancePolicyAllowedIPResourcesItem by calling from_dict on the json representation
        get_instance_policy_allowed_ip_resources_item_model_dict = GetInstancePolicyAllowedIPResourcesItem.from_dict(get_instance_policy_allowed_ip_resources_item_model_json).__dict__
        get_instance_policy_allowed_ip_resources_item_model2 = GetInstancePolicyAllowedIPResourcesItem(**get_instance_policy_allowed_ip_resources_item_model_dict)

        # Verify the model instances are equivalent
        assert get_instance_policy_allowed_ip_resources_item_model == get_instance_policy_allowed_ip_resources_item_model2

        # Convert model instance back to dict and verify no loss of data
        get_instance_policy_allowed_ip_resources_item_model_json2 = get_instance_policy_allowed_ip_resources_item_model.to_dict()
        assert get_instance_policy_allowed_ip_resources_item_model_json2 == get_instance_policy_allowed_ip_resources_item_model_json
...
class TestModel_GetInstancePolicyAllowedIPResourcesItemPolicyData:
    ...
    def test_get_instance_policy_allowed_ip_resources_item_policy_data_serialization(self):
        """
        ...
        get_instance_policy_allowed_ip_resources_item_policy_data_model_json['attributes'] = get_instance_policy_allowed_ip_resources_item_policy_data_attributes_model
        ...
        get_instance_policy_allowed_ip_resources_item_policy_data_model = GetInstancePolicyAllowedIPResourcesItemPolicyData.from_dict(get_instance_policy_allowed_ip_resources_item_policy_data_model_json)
        assert get_instance_policy_allowed_ip_resources_item_policy_data_model != False

        # Construct a model instance of GetInstancePolicyAllowedIPResourcesItemPolicyData by calling from_dict on the json representation
        get_instance_policy_allowed_ip_resources_item_policy_data_model_dict = GetInstancePolicyAllowedIPResourcesItemPolicyData.from_dict(get_instance_policy_allowed_ip_resources_item_policy_data_model_json).__dict__
        get_instance_policy_allowed_ip_resources_item_policy_data_model2 = GetInstancePolicyAllowedIPResourcesItemPolicyData(**get_instance_policy_allowed_ip_resources_item_policy_data_model_dict)

        # Verify the model instances are equivalent
        assert get_instance_policy_allowed_ip_resources_item_policy_data_model == get_instance_policy_allowed_ip_resources_item_policy_data_model2

        # Convert model instance back to dict and verify no loss of data
        get_instance_policy_allowed_ip_resources_item_policy_data_model_json2 = get_instance_policy_allowed_ip_resources_item_policy_data_model.to_dict()
        assert get_instance_policy_allowed_ip_resources_item_policy_data_model_json2 == get_instance_policy_allowed_ip_resources_item_policy_data_model_json
...
class TestModel_GetInstancePolicyAllowedIPResourcesItemPolicyDataAttributes:
    ...
    def test_get_instance_policy_allowed_ip_resources_item_policy_data_attributes_serialization(self):
        """
        ...
        get_instance_policy_allowed_ip_resources_item_policy_data_attributes_model_json['allowed_ip'] = ['10.1.0.0/32', '10.0.0.0/24', '192.0.2.0/32', '198.51.100.0/24', '2001:db8::/60']
        ...
        get_instance_policy_allowed_ip_resources_item_policy_data_attributes_model = GetInstancePolicyAllowedIPResourcesItemPolicyDataAttributes.from_dict(get_instance_policy_allowed_ip_resources_item_policy_data_attributes_model_json)
        assert get_instance_policy_allowed_ip_resources_item_policy_data_attributes_model != False

        # Construct a model instance of GetInstancePolicyAllowedIPResourcesItemPolicyDataAttributes by calling from_dict on the json representation
        get_instance_policy_allowed_ip_resources_item_policy_data_attributes_model_dict = GetInstancePolicyAllowedIPResourcesItemPolicyDataAttributes.from_dict(get_instance_policy_allowed_ip_resources_item_policy_data_attributes_model_json).__dict__
        get_instance_policy_allowed_ip_resources_item_policy_data_attributes_model2 = GetInstancePolicyAllowedIPResourcesItemPolicyDataAttributes(**get_instance_policy_allowed_ip_resources_item_policy_data_attributes_model_dict)

        # Verify the model instances are equivalent
        assert get_instance_policy_allowed_ip_resources_item_policy_data_attributes_model == get_instance_policy_allowed_ip_resources_item_policy_data_attributes_model2

        # Convert model instance back to dict and verify no loss of data
        get_instance_policy_allowed_ip_resources_item_policy_data_attributes_model_json2 = get_instance_policy_allowed_ip_resources_item_policy_data_attributes_model.to_dict()
        assert get_instance_policy_allowed_ip_resources_item_policy_data_attributes_model_json2 == get_instance_policy_allowed_ip_resources_item_policy_data_attributes_model_json
...
class TestModel_GetInstancePolicyDualAuthDeleteResourcesItem:
    ...
    def test_get_instance_policy_dual_auth_delete_resources_item_serialization(self):
        ...
        get_instance_policy_dual_auth_delete_resources_item_model_json['policy_data'] = dual_auth_delete_properties_model
        ...
        get_instance_policy_dual_auth_delete_resources_item_model = GetInstancePolicyDualAuthDeleteResourcesItem.from_dict(get_instance_policy_dual_auth_delete_resources_item_model_json)
        assert get_instance_policy_dual_auth_delete_resources_item_model != False

        # Construct a model instance of GetInstancePolicyDualAuthDeleteResourcesItem by calling from_dict on the json representation
        get_instance_policy_dual_auth_delete_resources_item_model_dict = GetInstancePolicyDualAuthDeleteResourcesItem.from_dict(get_instance_policy_dual_auth_delete_resources_item_model_json).__dict__
        get_instance_policy_dual_auth_delete_resources_item_model2 = GetInstancePolicyDualAuthDeleteResourcesItem(**get_instance_policy_dual_auth_delete_resources_item_model_dict)

        # Verify the model instances are equivalent
        assert get_instance_policy_dual_auth_delete_resources_item_model == get_instance_policy_dual_auth_delete_resources_item_model2

        # Convert model instance back to dict and verify no loss of data
        get_instance_policy_dual_auth_delete_resources_item_model_json2 = get_instance_policy_dual_auth_delete_resources_item_model.to_dict()
        assert get_instance_policy_dual_auth_delete_resources_item_model_json2 == get_instance_policy_dual_auth_delete_resources_item_model_json
...
class TestModel_GetInstancePolicyMetricsResourcesItem:
    ...
    def test_get_instance_policy_metrics_resources_item_serialization(self):
        ...
        get_instance_policy_metrics_resources_item_model = GetInstancePolicyMetricsResourcesItem.from_dict(get_instance_policy_metrics_resources_item_model_json)
        assert get_instance_policy_metrics_resources_item_model != False

        # Construct a model instance of GetInstancePolicyMetricsResourcesItem by calling from_dict on the json representation
        get_instance_policy_metrics_resources_item_model_dict = GetInstancePolicyMetricsResourcesItem.from_dict(get_instance_policy_metrics_resources_item_model_json).__dict__
        get_instance_policy_metrics_resources_item_model2 = GetInstancePolicyMetricsResourcesItem(**get_instance_policy_metrics_resources_item_model_dict)

        # Verify the model instances are equivalent
        assert get_instance_policy_metrics_resources_item_model == get_instance_policy_metrics_resources_item_model2

        # Convert model instance back to dict and verify no loss of data
        get_instance_policy_metrics_resources_item_model_json2 = get_instance_policy_metrics_resources_item_model.to_dict()
        assert get_instance_policy_metrics_resources_item_model_json2 == get_instance_policy_metrics_resources_item_model_json
...
class TestModel_GetInstancePolicyRotationResourcesItem:
    ...
    def test_get_instance_policy_rotation_resources_item_serialization(self):
        ...
        get_instance_policy_rotation_resources_item_policy_data_attributes_model = {}  # GetInstancePolicyRotationResourcesItemPolicyDataAttributes
        get_instance_policy_rotation_resources_item_policy_data_attributes_model['interval_month'] = 3

        get_instance_policy_rotation_resources_item_policy_data_model = {}  # GetInstancePolicyRotationResourcesItemPolicyData
        get_instance_policy_rotation_resources_item_policy_data_model['enabled'] = True
        get_instance_policy_rotation_resources_item_policy_data_model['attributes'] = get_instance_policy_rotation_resources_item_policy_data_attributes_model
        ...
        get_instance_policy_rotation_resources_item_model_json['policy_data'] = get_instance_policy_rotation_resources_item_policy_data_model

        # Construct a model instance of GetInstancePolicyRotationResourcesItem by calling from_dict on the json representation
        get_instance_policy_rotation_resources_item_model = GetInstancePolicyRotationResourcesItem.from_dict(get_instance_policy_rotation_resources_item_model_json)
        assert get_instance_policy_rotation_resources_item_model != False

        # Construct a model instance of GetInstancePolicyRotationResourcesItem by calling from_dict on the json representation
        get_instance_policy_rotation_resources_item_model_dict = GetInstancePolicyRotationResourcesItem.from_dict(get_instance_policy_rotation_resources_item_model_json).__dict__
        get_instance_policy_rotation_resources_item_model2 = GetInstancePolicyRotationResourcesItem(**get_instance_policy_rotation_resources_item_model_dict)

        # Verify the model instances are equivalent
        assert get_instance_policy_rotation_resources_item_model == get_instance_policy_rotation_resources_item_model2

        # Convert model instance back to dict and verify no loss of data
        get_instance_policy_rotation_resources_item_model_json2 = get_instance_policy_rotation_resources_item_model.to_dict()
        assert get_instance_policy_rotation_resources_item_model_json2 == get_instance_policy_rotation_resources_item_model_json
...
class TestModel_GetInstancePolicyRotationResourcesItemPolicyData:
    ...
    def test_get_instance_policy_rotation_resources_item_policy_data_serialization(self):
        """
        ...
        get_instance_policy_rotation_resources_item_policy_data_model_json['attributes'] = get_instance_policy_rotation_resources_item_policy_data_attributes_model
        ...
        get_instance_policy_rotation_resources_item_policy_data_model = GetInstancePolicyRotationResourcesItemPolicyData.from_dict(get_instance_policy_rotation_resources_item_policy_data_model_json)
        assert get_instance_policy_rotation_resources_item_policy_data_model != False

        # Construct a model instance of GetInstancePolicyRotationResourcesItemPolicyData by calling from_dict on the json representation
        get_instance_policy_rotation_resources_item_policy_data_model_dict = GetInstancePolicyRotationResourcesItemPolicyData.from_dict(get_instance_policy_rotation_resources_item_policy_data_model_json).__dict__
        get_instance_policy_rotation_resources_item_policy_data_model2 = GetInstancePolicyRotationResourcesItemPolicyData(**get_instance_policy_rotation_resources_item_policy_data_model_dict)

        # Verify the model instances are equivalent
        assert get_instance_policy_rotation_resources_item_policy_data_model == get_instance_policy_rotation_resources_item_policy_data_model2

        # Convert model instance back to dict and verify no loss of data
        get_instance_policy_rotation_resources_item_policy_data_model_json2 = get_instance_policy_rotation_resources_item_policy_data_model.to_dict()
        assert get_instance_policy_rotation_resources_item_policy_data_model_json2 == get_instance_policy_rotation_resources_item_policy_data_model_json
...
class TestModel_GetInstancePolicyRotationResourcesItemPolicyDataAttributes:
    ...
    def test_get_instance_policy_rotation_resources_item_policy_data_attributes_serialization(self):
        """
        ...
        get_instance_policy_rotation_resources_item_policy_data_attributes_model = GetInstancePolicyRotationResourcesItemPolicyDataAttributes.from_dict(get_instance_policy_rotation_resources_item_policy_data_attributes_model_json)
        assert get_instance_policy_rotation_resources_item_policy_data_attributes_model != False

        # Construct a model instance of GetInstancePolicyRotationResourcesItemPolicyDataAttributes by calling from_dict on the json representation
        get_instance_policy_rotation_resources_item_policy_data_attributes_model_dict = GetInstancePolicyRotationResourcesItemPolicyDataAttributes.from_dict(get_instance_policy_rotation_resources_item_policy_data_attributes_model_json).__dict__
        get_instance_policy_rotation_resources_item_policy_data_attributes_model2 = GetInstancePolicyRotationResourcesItemPolicyDataAttributes(**get_instance_policy_rotation_resources_item_policy_data_attributes_model_dict)

        # Verify the model instances are equivalent
        assert get_instance_policy_rotation_resources_item_policy_data_attributes_model == get_instance_policy_rotation_resources_item_policy_data_attributes_model2

        # Convert model instance back to dict and verify no loss of data
        get_instance_policy_rotation_resources_item_policy_data_attributes_model_json2 = get_instance_policy_rotation_resources_item_policy_data_attributes_model.to_dict()
        assert get_instance_policy_rotation_resources_item_policy_data_attributes_model_json2 == get_instance_policy_rotation_resources_item_policy_data_attributes_model_json
...
class TestModel_GetKeyPoliciesOneOfGetKeyPolicyDualAuthDeleteResourcesItem:
    ...
    def test_get_key_policies_one_of_get_key_policy_dual_auth_delete_resources_item_serialization(self):
        """
        ...
        get_key_policies_one_of_get_key_policy_dual_auth_delete_resources_item_model_json['type'] = 'application/vnd.ibm.kms.policy+json'
        get_key_policies_one_of_get_key_policy_dual_auth_delete_resources_item_model_json['dualAuthDelete'] = key_policy_dual_auth_delete_dual_auth_delete_model
        ...
        get_key_policies_one_of_get_key_policy_dual_auth_delete_resources_item_model = GetKeyPoliciesOneOfGetKeyPolicyDualAuthDeleteResourcesItem.from_dict(get_key_policies_one_of_get_key_policy_dual_auth_delete_resources_item_model_json)
        assert get_key_policies_one_of_get_key_policy_dual_auth_delete_resources_item_model != False

        # Construct a model instance of GetKeyPoliciesOneOfGetKeyPolicyDualAuthDeleteResourcesItem by calling from_dict on the json representation
        get_key_policies_one_of_get_key_policy_dual_auth_delete_resources_item_model_dict = GetKeyPoliciesOneOfGetKeyPolicyDualAuthDeleteResourcesItem.from_dict(get_key_policies_one_of_get_key_policy_dual_auth_delete_resources_item_model_json).__dict__
        get_key_policies_one_of_get_key_policy_dual_auth_delete_resources_item_model2 = GetKeyPoliciesOneOfGetKeyPolicyDualAuthDeleteResourcesItem(**get_key_policies_one_of_get_key_policy_dual_auth_delete_resources_item_model_dict)

        # Verify the model instances are equivalent
        assert get_key_policies_one_of_get_key_policy_dual_auth_delete_resources_item_model == get_key_policies_one_of_get_key_policy_dual_auth_delete_resources_item_model2

        # Convert model instance back to dict and verify no loss of data
        get_key_policies_one_of_get_key_policy_dual_auth_delete_resources_item_model_json2 = get_key_policies_one_of_get_key_policy_dual_auth_delete_resources_item_model.to_dict()
        assert get_key_policies_one_of_get_key_policy_dual_auth_delete_resources_item_model_json2 == get_key_policies_one_of_get_key_policy_dual_auth_delete_resources_item_model_json
...
class TestModel_GetKeyPolicyRotationResourcesItem:
    ...
    def test_get_key_policy_rotation_resources_item_serialization(self):
        ...
        get_key_policy_rotation_resources_item_model = GetKeyPolicyRotationResourcesItem.from_dict(get_key_policy_rotation_resources_item_model_json)
        assert get_key_policy_rotation_resources_item_model != False

        # Construct a model instance of GetKeyPolicyRotationResourcesItem by calling from_dict on the json representation
        get_key_policy_rotation_resources_item_model_dict = GetKeyPolicyRotationResourcesItem.from_dict(get_key_policy_rotation_resources_item_model_json).__dict__
        get_key_policy_rotation_resources_item_model2 = GetKeyPolicyRotationResourcesItem(**get_key_policy_rotation_resources_item_model_dict)
...
class TestModel_GetMultipleKeyPoliciesResource:
    ...
    def test_get_multiple_key_policies_resource_serialization(self):
        ...
        get_multiple_key_policies_resource_model_json['dualAuthDelete'] = get_multiple_key_policies_resource_dual_auth_delete_model
        ...
        get_multiple_key_policies_resource_model = GetMultipleKeyPoliciesResource.from_dict(get_multiple_key_policies_resource_model_json)
        assert get_multiple_key_policies_resource_model != False

        # Construct a model instance of GetMultipleKeyPoliciesResource by calling from_dict on the json representation
        get_multiple_key_policies_resource_model_dict = GetMultipleKeyPoliciesResource.from_dict(get_multiple_key_policies_resource_model_json).__dict__
        get_multiple_key_policies_resource_model2 = GetMultipleKeyPoliciesResource(**get_multiple_key_policies_resource_model_dict)
...
class TestModel_GetMultipleKeyPoliciesResourceDualAuthDelete:
    ...
    def test_get_multiple_key_policies_resource_dual_auth_delete_serialization(self):
        ...
        get_multiple_key_policies_resource_dual_auth_delete_model = GetMultipleKeyPoliciesResourceDualAuthDelete.from_dict(get_multiple_key_policies_resource_dual_auth_delete_model_json)
        assert get_multiple_key_policies_resource_dual_auth_delete_model != False

        # Construct a model instance of GetMultipleKeyPoliciesResourceDualAuthDelete by calling from_dict on the json representation
        get_multiple_key_policies_resource_dual_auth_delete_model_dict = GetMultipleKeyPoliciesResourceDualAuthDelete.from_dict(get_multiple_key_policies_resource_dual_auth_delete_model_json).__dict__
        get_multiple_key_policies_resource_dual_auth_delete_model2 = GetMultipleKeyPoliciesResourceDualAuthDelete(**get_multiple_key_policies_resource_dual_auth_delete_model_dict)

        # Verify the model instances are equivalent
        assert get_multiple_key_policies_resource_dual_auth_delete_model == get_multiple_key_policies_resource_dual_auth_delete_model2

        # Convert model instance back to dict and verify no loss of data
        get_multiple_key_policies_resource_dual_auth_delete_model_json2 = get_multiple_key_policies_resource_dual_auth_delete_model.to_dict()
        assert get_multiple_key_policies_resource_dual_auth_delete_model_json2 == get_multiple_key_policies_resource_dual_auth_delete_model_json
...
class TestModel_InstancePolicyAllowedIPPolicyData:
    ...
    def test_instance_policy_allowed_ip_policy_data_serialization(self):
        ...
        instance_policy_allowed_ip_policy_data_attributes_model['allowed_ip'] = ['10.1.0.0/32', '10.0.0.0/24', '192.0.2.0/32', '198.51.100.0/24', '2001:db8::/60']
        ...
        instance_policy_allowed_ip_policy_data_model_json['attributes'] = instance_policy_allowed_ip_policy_data_attributes_model

        # Construct a model instance of InstancePolicyAllowedIPPolicyData by calling from_dict on the json representation
        instance_policy_allowed_ip_policy_data_model = InstancePolicyAllowedIPPolicyData.from_dict(instance_policy_allowed_ip_policy_data_model_json)
        assert instance_policy_allowed_ip_policy_data_model != False

        # Construct a model instance of InstancePolicyAllowedIPPolicyData by calling from_dict on the json representation
        instance_policy_allowed_ip_policy_data_model_dict = InstancePolicyAllowedIPPolicyData.from_dict(instance_policy_allowed_ip_policy_data_model_json).__dict__
        instance_policy_allowed_ip_policy_data_model2 = InstancePolicyAllowedIPPolicyData(**instance_policy_allowed_ip_policy_data_model_dict)
...
class TestModel_InstancePolicyAllowedIPPolicyDataAttributes:
    ...
    def test_instance_policy_allowed_ip_policy_data_attributes_serialization(self):
        ...
        instance_policy_allowed_ip_policy_data_attributes_model_json['allowed_ip'] = ['10.1.0.0/32', '10.0.0.0/24', '192.0.2.0/32', '198.51.100.0/24', '2001:db8::/60']
        ...
        instance_policy_allowed_ip_policy_data_attributes_model = InstancePolicyAllowedIPPolicyDataAttributes.from_dict(instance_policy_allowed_ip_policy_data_attributes_model_json)
        assert instance_policy_allowed_ip_policy_data_attributes_model != False

        # Construct a model instance of InstancePolicyAllowedIPPolicyDataAttributes by calling from_dict on the json representation
        instance_policy_allowed_ip_policy_data_attributes_model_dict = InstancePolicyAllowedIPPolicyDataAttributes.from_dict(instance_policy_allowed_ip_policy_data_attributes_model_json).__dict__
        instance_policy_allowed_ip_policy_data_attributes_model2 = InstancePolicyAllowedIPPolicyDataAttributes(**instance_policy_allowed_ip_policy_data_attributes_model_dict)

        # Verify the model instances are equivalent
        assert instance_policy_allowed_ip_policy_data_attributes_model == instance_policy_allowed_ip_policy_data_attributes_model2

        # Convert model instance back to dict and verify no loss of data
        instance_policy_allowed_ip_policy_data_attributes_model_json2 = instance_policy_allowed_ip_policy_data_attributes_model.to_dict()
        assert instance_policy_allowed_ip_policy_data_attributes_model_json2 == instance_policy_allowed_ip_policy_data_attributes_model_json
...
class TestModel_InstancePolicyAllowedNetworkPolicyData:
    ...
    def test_instance_policy_allowed_network_policy_data_serialization(self):
        ...
        instance_policy_allowed_network_policy_data_attributes_model = {}  # InstancePolicyAllowedNetworkPolicyDataAttributes
        ...
        instance_policy_allowed_network_policy_data_model_json['attributes'] = instance_policy_allowed_network_policy_data_attributes_model

        # Construct a model instance of InstancePolicyAllowedNetworkPolicyData by calling from_dict on the json representation
        instance_policy_allowed_network_policy_data_model = InstancePolicyAllowedNetworkPolicyData.from_dict(instance_policy_allowed_network_policy_data_model_json)
        assert instance_policy_allowed_network_policy_data_model != False

        # Construct a model instance of InstancePolicyAllowedNetworkPolicyData by calling from_dict on the json representation
        instance_policy_allowed_network_policy_data_model_dict = InstancePolicyAllowedNetworkPolicyData.from_dict(instance_policy_allowed_network_policy_data_model_json).__dict__
        instance_policy_allowed_network_policy_data_model2 = InstancePolicyAllowedNetworkPolicyData(**instance_policy_allowed_network_policy_data_model_dict)

        # Verify the model instances are equivalent
        assert instance_policy_allowed_network_policy_data_model == instance_policy_allowed_network_policy_data_model2

        # Convert model instance back to dict and verify no loss of data
        instance_policy_allowed_network_policy_data_model_json2 = instance_policy_allowed_network_policy_data_model.to_dict()
        assert instance_policy_allowed_network_policy_data_model_json2 == instance_policy_allowed_network_policy_data_model_json
...
class TestModel_InstancePolicyAllowedNetworkPolicyDataAttributes:
    ...
    def test_instance_policy_allowed_network_policy_data_attributes_serialization(self):
        ...
        instance_policy_allowed_network_policy_data_attributes_model = InstancePolicyAllowedNetworkPolicyDataAttributes.from_dict(instance_policy_allowed_network_policy_data_attributes_model_json)
        assert instance_policy_allowed_network_policy_data_attributes_model != False

        # Construct a model instance of InstancePolicyAllowedNetworkPolicyDataAttributes by calling from_dict on the json representation
        instance_policy_allowed_network_policy_data_attributes_model_dict = InstancePolicyAllowedNetworkPolicyDataAttributes.from_dict(instance_policy_allowed_network_policy_data_attributes_model_json).__dict__
        instance_policy_allowed_network_policy_data_attributes_model2 = InstancePolicyAllowedNetworkPolicyDataAttributes(**instance_policy_allowed_network_policy_data_attributes_model_dict)

        # Verify the model instances are equivalent
        assert instance_policy_allowed_network_policy_data_attributes_model == instance_policy_allowed_network_policy_data_attributes_model2

        # Convert model instance back to dict and verify no loss of data
        instance_policy_allowed_network_policy_data_attributes_model_json2 = instance_policy_allowed_network_policy_data_attributes_model.to_dict()
        assert instance_policy_allowed_network_policy_data_attributes_model_json2 == instance_policy_allowed_network_policy_data_attributes_model_json
...
class TestModel_InstancePolicyKeyCreateImportAccessPolicyData:
    ...
    def test_instance_policy_key_create_import_access_policy_data_serialization(self):
        ...
        instance_policy_key_create_import_access_policy_data_attributes_model = {}  # InstancePolicyKeyCreateImportAccessPolicyDataAttributes
        ...
        instance_policy_key_create_import_access_policy_data_model_json['attributes'] = instance_policy_key_create_import_access_policy_data_attributes_model
        ...
        instance_policy_key_create_import_access_policy_data_model = InstancePolicyKeyCreateImportAccessPolicyData.from_dict(instance_policy_key_create_import_access_policy_data_model_json)
        assert instance_policy_key_create_import_access_policy_data_model != False

        # Construct a model instance of InstancePolicyKeyCreateImportAccessPolicyData by calling from_dict on the json representation
        instance_policy_key_create_import_access_policy_data_model_dict = InstancePolicyKeyCreateImportAccessPolicyData.from_dict(instance_policy_key_create_import_access_policy_data_model_json).__dict__
        instance_policy_key_create_import_access_policy_data_model2 = InstancePolicyKeyCreateImportAccessPolicyData(**instance_policy_key_create_import_access_policy_data_model_dict)

        # Verify the model instances are equivalent
        assert instance_policy_key_create_import_access_policy_data_model == instance_policy_key_create_import_access_policy_data_model2

        # Convert model instance back to dict and verify no loss of data
        instance_policy_key_create_import_access_policy_data_model_json2 = instance_policy_key_create_import_access_policy_data_model.to_dict()
        assert instance_policy_key_create_import_access_policy_data_model_json2 == instance_policy_key_create_import_access_policy_data_model_json
...
class TestModel_InstancePolicyKeyCreateImportAccessPolicyDataAttributes:
    ...
    def test_instance_policy_key_create_import_access_policy_data_attributes_serialization(self):
        """
        ...
        instance_policy_key_create_import_access_policy_data_attributes_model = InstancePolicyKeyCreateImportAccessPolicyDataAttributes.from_dict(instance_policy_key_create_import_access_policy_data_attributes_model_json)
        assert instance_policy_key_create_import_access_policy_data_attributes_model != False

        # Construct a model instance of InstancePolicyKeyCreateImportAccessPolicyDataAttributes by calling from_dict on the json representation
        instance_policy_key_create_import_access_policy_data_attributes_model_dict = InstancePolicyKeyCreateImportAccessPolicyDataAttributes.from_dict(instance_policy_key_create_import_access_policy_data_attributes_model_json).__dict__
        instance_policy_key_create_import_access_policy_data_attributes_model2 = InstancePolicyKeyCreateImportAccessPolicyDataAttributes(**instance_policy_key_create_import_access_policy_data_attributes_model_dict)

        # Verify the model instances are equivalent
        assert instance_policy_key_create_import_access_policy_data_attributes_model == instance_policy_key_create_import_access_policy_data_attributes_model2

        # Convert model instance back to dict and verify no loss of data
        instance_policy_key_create_import_access_policy_data_attributes_model_json2 = instance_policy_key_create_import_access_policy_data_attributes_model.to_dict()
        assert instance_policy_key_create_import_access_policy_data_attributes_model_json2 == instance_policy_key_create_import_access_policy_data_attributes_model_json
...
class TestModel_InstancePolicyProperties:
    ...
    def test_instance_policy_properties_serialization(self):
        ...
        instance_policy_properties_attributes_model['allowed_ip'] = ['10.1.0.0/32', '10.0.0.0/24', '192.0.2.0/32', '198.51.100.0/24', '2001:db8::/60']
        ...
        # Construct a model instance of InstancePolicyProperties by calling from_dict on the json representation
        instance_policy_properties_model_dict = InstancePolicyProperties.from_dict(instance_policy_properties_model_json).__dict__
...
class TestModel_InstancePolicyPropertiesAttributes:
    ...
    def test_instance_policy_properties_attributes_serialization(self):
        ...
        instance_policy_properties_attributes_model_json['allowed_ip'] = ['10.1.0.0/32', '10.0.0.0/24', '192.0.2.0/32', '198.51.100.0/24', '2001:db8::/60']
        ...
        instance_policy_properties_attributes_model = InstancePolicyPropertiesAttributes.from_dict(instance_policy_properties_attributes_model_json)
        assert instance_policy_properties_attributes_model != False

        # Construct a model instance of InstancePolicyPropertiesAttributes by calling from_dict on the json representation
        instance_policy_properties_attributes_model_dict = InstancePolicyPropertiesAttributes.from_dict(instance_policy_properties_attributes_model_json).__dict__
        instance_policy_properties_attributes_model2 = InstancePolicyPropertiesAttributes(**instance_policy_properties_attributes_model_dict)
...
class TestModel_InstancePolicyResource:
    ...
    def test_instance_policy_resource_serialization(self):
        ...
        # Construct a model instance of InstancePolicyResource by calling from_dict on the json representation
        instance_policy_resource_model_dict = InstancePolicyResource.from_dict(instance_policy_resource_model_json).__dict__
...
class TestModel_InstancePolicyRotationPolicyData:
    ...
    def test_instance_policy_rotation_policy_data_serialization(self):
        ...
        instance_policy_rotation_policy_data_model_json['attributes'] = instance_policy_rotation_policy_data_attributes_model

        # Construct a model instance of InstancePolicyRotationPolicyData by calling from_dict on the json representation
        instance_policy_rotation_policy_data_model = InstancePolicyRotationPolicyData.from_dict(instance_policy_rotation_policy_data_model_json)
        assert instance_policy_rotation_policy_data_model != False

        # Construct a model instance of InstancePolicyRotationPolicyData by calling from_dict on the json representation
        instance_policy_rotation_policy_data_model_dict = InstancePolicyRotationPolicyData.from_dict(instance_policy_rotation_policy_data_model_json).__dict__
        instance_policy_rotation_policy_data_model2 = InstancePolicyRotationPolicyData(**instance_policy_rotation_policy_data_model_dict)
...
class TestModel_InstancePolicyRotationPolicyDataAttributes:
    ...
    def test_instance_policy_rotation_policy_data_attributes_serialization(self):
        ...
        instance_policy_rotation_policy_data_attributes_model = InstancePolicyRotationPolicyDataAttributes.from_dict(instance_policy_rotation_policy_data_attributes_model_json)
        assert instance_policy_rotation_policy_data_attributes_model != False

        # Construct a model instance of InstancePolicyRotationPolicyDataAttributes by calling from_dict on the json representation
        instance_policy_rotation_policy_data_attributes_model_dict = InstancePolicyRotationPolicyDataAttributes.from_dict(instance_policy_rotation_policy_data_attributes_model_json).__dict__
        instance_policy_rotation_policy_data_attributes_model2 = InstancePolicyRotationPolicyDataAttributes(**instance_policy_rotation_policy_data_attributes_model_dict)

        # Verify the model instances are equivalent
        assert instance_policy_rotation_policy_data_attributes_model == instance_policy_rotation_policy_data_attributes_model2

        # Convert model instance back to dict and verify no loss of data
        instance_policy_rotation_policy_data_attributes_model_json2 = instance_policy_rotation_policy_data_attributes_model.to_dict()
        assert instance_policy_rotation_policy_data_attributes_model_json2 == instance_policy_rotation_policy_data_attributes_model_json
...
class TestModel_KMIPClientCertificate:
    ...
    def test_kmip_client_certificate_serialization(self):
        ...
        # Construct a model instance of KMIPClientCertificate by calling from_dict on the json representation
        kmip_client_certificate_model_dict = KMIPClientCertificate.from_dict(kmip_client_certificate_model_json).__dict__
...
class TestModel_KMIPClientPartialCertificate:
    ...
    def test_kmip_client_partial_certificate_serialization(self):
        ...
        kmip_client_partial_certificate_model = KMIPClientPartialCertificate.from_dict(kmip_client_partial_certificate_model_json)
        assert kmip_client_partial_certificate_model != False

        # Construct a model instance of KMIPClientPartialCertificate by calling from_dict on the json representation
        kmip_client_partial_certificate_model_dict = KMIPClientPartialCertificate.from_dict(kmip_client_partial_certificate_model_json).__dict__
        kmip_client_partial_certificate_model2 = KMIPClientPartialCertificate(**kmip_client_partial_certificate_model_dict)
...
class TestModel_KeyFullRepresentation:
    ...
    def test_key_full_representation_serialization(self):
        ...
        # Construct a model instance of KeyFullRepresentation by calling from_dict on the json representation
        key_full_representation_model_dict = KeyFullRepresentation.from_dict(key_full_representation_model_json).__dict__
...
class TestModel_KeyFullRepresentationAlgorithmMetadata:
    ...
    def test_key_full_representation_algorithm_metadata_serialization(self):
        ...
        key_full_representation_algorithm_metadata_model = KeyFullRepresentationAlgorithmMetadata.from_dict(key_full_representation_algorithm_metadata_model_json)
        assert key_full_representation_algorithm_metadata_model != False

        # Construct a model instance of KeyFullRepresentationAlgorithmMetadata by calling from_dict on the json representation
        key_full_representation_algorithm_metadata_model_dict = KeyFullRepresentationAlgorithmMetadata.from_dict(key_full_representation_algorithm_metadata_model_json).__dict__
        key_full_representation_algorithm_metadata_model2 = KeyFullRepresentationAlgorithmMetadata(**key_full_representation_algorithm_metadata_model_dict)

        # Verify the model instances are equivalent
        assert key_full_representation_algorithm_metadata_model == key_full_representation_algorithm_metadata_model2

        # Convert model instance back to dict and verify no loss of data
        key_full_representation_algorithm_metadata_model_json2 = key_full_representation_algorithm_metadata_model.to_dict()
        assert key_full_representation_algorithm_metadata_model_json2 == key_full_representation_algorithm_metadata_model_json
...
class TestModel_KeyPolicyDualAuthDelete:
    ...
    def test_key_policy_dual_auth_delete_serialization(self):
        ...
        # Construct a model instance of KeyPolicyDualAuthDelete by calling from_dict on the json representation
        key_policy_dual_auth_delete_model_dict = KeyPolicyDualAuthDelete.from_dict(key_policy_dual_auth_delete_model_json).__dict__
...
class TestModel_KeyPolicyDualAuthDeleteDualAuthDelete:
    ...
    def test_key_policy_dual_auth_delete_dual_auth_delete_serialization(self):
        ...
        key_policy_dual_auth_delete_dual_auth_delete_model = KeyPolicyDualAuthDeleteDualAuthDelete.from_dict(key_policy_dual_auth_delete_dual_auth_delete_model_json)
        assert key_policy_dual_auth_delete_dual_auth_delete_model != False

        # Construct a model instance of KeyPolicyDualAuthDeleteDualAuthDelete by calling from_dict on the json representation
        key_policy_dual_auth_delete_dual_auth_delete_model_dict = KeyPolicyDualAuthDeleteDualAuthDelete.from_dict(key_policy_dual_auth_delete_dual_auth_delete_model_json).__dict__
        key_policy_dual_auth_delete_dual_auth_delete_model2 = KeyPolicyDualAuthDeleteDualAuthDelete(**key_policy_dual_auth_delete_dual_auth_delete_model_dict)

        # Verify the model instances are equivalent
        assert key_policy_dual_auth_delete_dual_auth_delete_model == key_policy_dual_auth_delete_dual_auth_delete_model2

        # Convert model instance back to dict and verify no loss of data
        key_policy_dual_auth_delete_dual_auth_delete_model_json2 = key_policy_dual_auth_delete_dual_auth_delete_model.to_dict()
        assert key_policy_dual_auth_delete_dual_auth_delete_model_json2 == key_policy_dual_auth_delete_dual_auth_delete_model_json
...
class TestModel_KeyPolicyRotationNonRequiredRotation:
    ...
    def test_key_policy_rotation_non_required_rotation_serialization(self):
        ...
        key_policy_rotation_non_required_rotation_model = KeyPolicyRotationNonRequiredRotation.from_dict(key_policy_rotation_non_required_rotation_model_json)
        assert key_policy_rotation_non_required_rotation_model != False

        # Construct a model instance of KeyPolicyRotationNonRequiredRotation by calling from_dict on the json representation
        key_policy_rotation_non_required_rotation_model_dict = KeyPolicyRotationNonRequiredRotation.from_dict(key_policy_rotation_non_required_rotation_model_json).__dict__
        key_policy_rotation_non_required_rotation_model2 = KeyPolicyRotationNonRequiredRotation(**key_policy_rotation_non_required_rotation_model_dict)

        # Verify the model instances are equivalent
        assert key_policy_rotation_non_required_rotation_model == key_policy_rotation_non_required_rotation_model2

        # Convert model instance back to dict and verify no loss of data
        key_policy_rotation_non_required_rotation_model_json2 = key_policy_rotation_non_required_rotation_model.to_dict()
        assert key_policy_rotation_non_required_rotation_model_json2 == key_policy_rotation_non_required_rotation_model_json
...
class TestModel_KeyPolicyRotationRotation:
    ...
    def test_key_policy_rotation_rotation_serialization(self):
        ...
        key_policy_rotation_rotation_model = KeyPolicyRotationRotation.from_dict(key_policy_rotation_rotation_model_json)
        assert key_policy_rotation_rotation_model != False

        # Construct a model instance of KeyPolicyRotationRotation by calling from_dict on the json representation
        key_policy_rotation_rotation_model_dict = KeyPolicyRotationRotation.from_dict(key_policy_rotation_rotation_model_json).__dict__
...
class TestModel_KeyWithPayloadAlgorithmMetadata:
    ...
    def test_key_with_payload_algorithm_metadata_serialization(self):
        ...
        key_with_payload_algorithm_metadata_model = KeyWithPayloadAlgorithmMetadata.from_dict(key_with_payload_algorithm_metadata_model_json)
        assert key_with_payload_algorithm_metadata_model != False

        # Construct a model instance of KeyWithPayloadAlgorithmMetadata by calling from_dict on the json representation
        key_with_payload_algorithm_metadata_model_dict = KeyWithPayloadAlgorithmMetadata.from_dict(key_with_payload_algorithm_metadata_model_json).__dict__
        key_with_payload_algorithm_metadata_model2 = KeyWithPayloadAlgorithmMetadata(**key_with_payload_algorithm_metadata_model_dict)
...
class TestModel_ListKMIPAdaptersWithTotalCount:
    ...
    def test_list_kmip_adapters_with_total_count_serialization(self):
        ...
        collection_metadata_with_total_count_model['collectionType'] = 'application/vnd.ibm.kms.allowed_ip_metadata+json'
        ...
        list_kmip_adapters_with_total_count_model = ListKMIPAdaptersWithTotalCount.from_dict(list_kmip_adapters_with_total_count_model_json)
        assert list_kmip_adapters_with_total_count_model != False

        # Construct a model instance of ListKMIPAdaptersWithTotalCount by calling from_dict on the json representation
        list_kmip_adapters_with_total_count_model_dict = ListKMIPAdaptersWithTotalCount.from_dict(list_kmip_adapters_with_total_count_model_json).__dict__
        list_kmip_adapters_with_total_count_model2 = ListKMIPAdaptersWithTotalCount(**list_kmip_adapters_with_total_count_model_dict)
...
class TestModel_ListKMIPClientCertificates:
    ...
    def test_list_kmip_client_certificates_serialization(self):
        ...
        list_kmip_client_certificates_model = ListKMIPClientCertificates.from_dict(list_kmip_client_certificates_model_json)
        assert list_kmip_client_certificates_model != False

        # Construct a model instance of ListKMIPClientCertificates by calling from_dict on the json representation
        list_kmip_client_certificates_model_dict = ListKMIPClientCertificates.from_dict(list_kmip_client_certificates_model_json).__dict__
...
class TestModel_ListKMIPObjectsWithTotalCount:
    ...
    def test_list_kmip_objects_with_total_count_serialization(self):
        ...
        list_kmip_objects_with_total_count_model = ListKMIPObjectsWithTotalCount.from_dict(list_kmip_objects_with_total_count_model_json)
        assert list_kmip_objects_with_total_count_model != False

        # Construct a model instance of ListKMIPObjectsWithTotalCount by calling from_dict on the json representation
        list_kmip_objects_with_total_count_model_dict = ListKMIPObjectsWithTotalCount.from_dict(list_kmip_objects_with_total_count_model_json).__dict__
        list_kmip_objects_with_total_count_model2 = ListKMIPObjectsWithTotalCount(**list_kmip_objects_with_total_count_model_dict)
...
class TestModel_ListKMIPPartialClientCertificatesWithTotalCount:
    ...
    def test_list_kmip_partial_client_certificates_with_total_count_serialization(self):
        ...
        list_kmip_partial_client_certificates_with_total_count_model_json['metadata'] = collection_metadata_with_total_count_model
        list_kmip_partial_client_certificates_with_total_count_model_json['resources'] = [kmip_client_partial_certificate_model]
        ...
        list_kmip_partial_client_certificates_with_total_count_model = ListKMIPPartialClientCertificatesWithTotalCount.from_dict(list_kmip_partial_client_certificates_with_total_count_model_json)
        assert list_kmip_partial_client_certificates_with_total_count_model != False

        # Construct a model instance of ListKMIPPartialClientCertificatesWithTotalCount by calling from_dict on the json representation
        list_kmip_partial_client_certificates_with_total_count_model_dict = ListKMIPPartialClientCertificatesWithTotalCount.from_dict(list_kmip_partial_client_certificates_with_total_count_model_json).__dict__
        list_kmip_partial_client_certificates_with_total_count_model2 = ListKMIPPartialClientCertificatesWithTotalCount(**list_kmip_partial_client_certificates_with_total_count_model_dict)

        # Verify the model instances are equivalent
        assert list_kmip_partial_client_certificates_with_total_count_model == list_kmip_partial_client_certificates_with_total_count_model2

        # Convert model instance back to dict and verify no loss of data
        list_kmip_partial_client_certificates_with_total_count_model_json2 = list_kmip_partial_client_certificates_with_total_count_model.to_dict()
        assert list_kmip_partial_client_certificates_with_total_count_model_json2 == list_kmip_partial_client_certificates_with_total_count_model_json
...
class TestModel_ListKeyRingsWithTotalCount:
    ...
    def test_list_key_rings_with_total_count_serialization(self):
        ...
        list_key_rings_with_total_count_model = ListKeyRingsWithTotalCount.from_dict(list_key_rings_with_total_count_model_json)
        assert list_key_rings_with_total_count_model != False

        # Construct a model instance of ListKeyRingsWithTotalCount by calling from_dict on the json representation
        list_key_rings_with_total_count_model_dict = ListKeyRingsWithTotalCount.from_dict(list_key_rings_with_total_count_model_json).__dict__
        list_key_rings_with_total_count_model2 = ListKeyRingsWithTotalCount(**list_key_rings_with_total_count_model_dict)
...
class TestModel_ListKeysMetadataPropertiesSearchQuery:
    ...
    def test_list_keys_metadata_properties_search_query_serialization(self):
        ...
        list_keys_metadata_properties_search_query_model = ListKeysMetadataPropertiesSearchQuery.from_dict(list_keys_metadata_properties_search_query_model_json)
        assert list_keys_metadata_properties_search_query_model != False

        # Construct a model instance of ListKeysMetadataPropertiesSearchQuery by calling from_dict on the json representation
        list_keys_metadata_properties_search_query_model_dict = ListKeysMetadataPropertiesSearchQuery.from_dict(list_keys_metadata_properties_search_query_model_json).__dict__
        list_keys_metadata_properties_search_query_model2 = ListKeysMetadataPropertiesSearchQuery(**list_keys_metadata_properties_search_query_model_dict)

        # Verify the model instances are equivalent
        assert list_keys_metadata_properties_search_query_model == list_keys_metadata_properties_search_query_model2

        # Convert model instance back to dict and verify no loss of data
        list_keys_metadata_properties_search_query_model_json2 = list_keys_metadata_properties_search_query_model.to_dict()
        assert list_keys_metadata_properties_search_query_model_json2 == list_keys_metadata_properties_search_query_model_json
...
class TestModel_RegistrationWithTotalCount:
    ...
    def test_registration_with_total_count_serialization(self):
        ...
        registration_with_total_count_model = RegistrationWithTotalCount.from_dict(registration_with_total_count_model_json)
        assert registration_with_total_count_model != False

        # Construct a model instance of RegistrationWithTotalCount by calling from_dict on the json representation
        registration_with_total_count_model_dict = RegistrationWithTotalCount.from_dict(registration_with_total_count_model_json).__dict__
...
class TestModel_RewrapKeyResponseBody:
    ...
    def test_rewrap_key_response_body_serialization(self):
        ...
        # Construct a model instance of RewrapKeyResponseBody by calling from_dict on the json representation
        rewrap_key_response_body_model_dict = RewrapKeyResponseBody.from_dict(rewrap_key_response_body_model_json).__dict__
...
class TestModel_RewrappedKeyVersionRewrappedKeyVersion:
    ...
    def test_rewrapped_key_version_rewrapped_key_version_serialization(self):
        ...
        rewrapped_key_version_rewrapped_key_version_model = RewrappedKeyVersionRewrappedKeyVersion.from_dict(rewrapped_key_version_rewrapped_key_version_model_json)
        assert rewrapped_key_version_rewrapped_key_version_model != False

        # Construct a model instance of RewrappedKeyVersionRewrappedKeyVersion by calling from_dict on the json representation
        rewrapped_key_version_rewrapped_key_version_model_dict = RewrappedKeyVersionRewrappedKeyVersion.from_dict(rewrapped_key_version_rewrapped_key_version_model_json).__dict__
        rewrapped_key_version_rewrapped_key_version_model2 = RewrappedKeyVersionRewrappedKeyVersion(**rewrapped_key_version_rewrapped_key_version_model_dict)

        # Verify the model instances are equivalent
        assert rewrapped_key_version_rewrapped_key_version_model == rewrapped_key_version_rewrapped_key_version_model2

        # Convert model instance back to dict and verify no loss of data
        rewrapped_key_version_rewrapped_key_version_model_json2 = rewrapped_key_version_rewrapped_key_version_model.to_dict()
        assert rewrapped_key_version_rewrapped_key_version_model_json2 == rewrapped_key_version_rewrapped_key_version_model_json
...
class TestModel_SetInstancePoliciesOneOfSetInstancePolicyAllowedIPResourcesItem:
    ...
    def test_set_instance_policies_one_of_set_instance_policy_allowed_ip_resources_item_serialization(self):
        """
        ...
        instance_policy_allowed_ip_policy_data_model['attributes'] = instance_policy_allowed_ip_policy_data_attributes_model
        ...
        set_instance_policies_one_of_set_instance_policy_allowed_ip_resources_item_model_json['policy_type'] = 'allowedIP'
        set_instance_policies_one_of_set_instance_policy_allowed_ip_resources_item_model_json['policy_data'] = instance_policy_allowed_ip_policy_data_model
        ...
        set_instance_policies_one_of_set_instance_policy_allowed_ip_resources_item_model = SetInstancePoliciesOneOfSetInstancePolicyAllowedIPResourcesItem.from_dict(set_instance_policies_one_of_set_instance_policy_allowed_ip_resources_item_model_json)
        assert set_instance_policies_one_of_set_instance_policy_allowed_ip_resources_item_model != False

        # Construct a model instance of SetInstancePoliciesOneOfSetInstancePolicyAllowedIPResourcesItem by calling from_dict on the json representation
        set_instance_policies_one_of_set_instance_policy_allowed_ip_resources_item_model_dict = SetInstancePoliciesOneOfSetInstancePolicyAllowedIPResourcesItem.from_dict(set_instance_policies_one_of_set_instance_policy_allowed_ip_resources_item_model_json).__dict__
        set_instance_policies_one_of_set_instance_policy_allowed_ip_resources_item_model2 = SetInstancePoliciesOneOfSetInstancePolicyAllowedIPResourcesItem(**set_instance_policies_one_of_set_instance_policy_allowed_ip_resources_item_model_dict)

        # Verify the model instances are equivalent
        assert set_instance_policies_one_of_set_instance_policy_allowed_ip_resources_item_model == set_instance_policies_one_of_set_instance_policy_allowed_ip_resources_item_model2

        # Convert model instance back to dict and verify no loss of data
        set_instance_policies_one_of_set_instance_policy_allowed_ip_resources_item_model_json2 = set_instance_policies_one_of_set_instance_policy_allowed_ip_resources_item_model.to_dict()
        assert set_instance_policies_one_of_set_instance_policy_allowed_ip_resources_item_model_json2 == set_instance_policies_one_of_set_instance_policy_allowed_ip_resources_item_model_json
...
class TestModel_SetInstancePoliciesOneOfSetInstancePolicyAllowedNetworkResourcesItem:
    ...
    def test_set_instance_policies_one_of_set_instance_policy_allowed_network_resources_item_serialization(self):
        """
        ...
        set_instance_policies_one_of_set_instance_policy_allowed_network_resources_item_model_json['policy_type'] = 'allowedNetwork'
        set_instance_policies_one_of_set_instance_policy_allowed_network_resources_item_model_json['policy_data'] = instance_policy_allowed_network_policy_data_model
        ...
        set_instance_policies_one_of_set_instance_policy_allowed_network_resources_item_model = SetInstancePoliciesOneOfSetInstancePolicyAllowedNetworkResourcesItem.from_dict(set_instance_policies_one_of_set_instance_policy_allowed_network_resources_item_model_json)
        assert set_instance_policies_one_of_set_instance_policy_allowed_network_resources_item_model != False

        # Construct a model instance of SetInstancePoliciesOneOfSetInstancePolicyAllowedNetworkResourcesItem by calling from_dict on the json representation
        set_instance_policies_one_of_set_instance_policy_allowed_network_resources_item_model_dict = SetInstancePoliciesOneOfSetInstancePolicyAllowedNetworkResourcesItem.from_dict(set_instance_policies_one_of_set_instance_policy_allowed_network_resources_item_model_json).__dict__
        set_instance_policies_one_of_set_instance_policy_allowed_network_resources_item_model2 = SetInstancePoliciesOneOfSetInstancePolicyAllowedNetworkResourcesItem(**set_instance_policies_one_of_set_instance_policy_allowed_network_resources_item_model_dict)

        # Verify the model instances are equivalent
        assert set_instance_policies_one_of_set_instance_policy_allowed_network_resources_item_model == set_instance_policies_one_of_set_instance_policy_allowed_network_resources_item_model2

        # Convert model instance back to dict and verify no loss of data
        set_instance_policies_one_of_set_instance_policy_allowed_network_resources_item_model_json2 = set_instance_policies_one_of_set_instance_policy_allowed_network_resources_item_model.to_dict()
        assert set_instance_policies_one_of_set_instance_policy_allowed_network_resources_item_model_json2 == set_instance_policies_one_of_set_instance_policy_allowed_network_resources_item_model_json
...
class TestModel_SetInstancePoliciesOneOfSetInstancePolicyKeyCreateImportAccessResourcesItem:
    ...
    def test_set_instance_policies_one_of_set_instance_policy_key_create_import_access_resources_item_serialization(self):
        """
        ...
        instance_policy_key_create_import_access_policy_data_model['attributes'] = instance_policy_key_create_import_access_policy_data_attributes_model
        ...
        set_instance_policies_one_of_set_instance_policy_key_create_import_access_resources_item_model_json['policy_type'] = 'keyCreateImportAccess'
        set_instance_policies_one_of_set_instance_policy_key_create_import_access_resources_item_model_json['policy_data'] = instance_policy_key_create_import_access_policy_data_model
        ...
        set_instance_policies_one_of_set_instance_policy_key_create_import_access_resources_item_model = SetInstancePoliciesOneOfSetInstancePolicyKeyCreateImportAccessResourcesItem.from_dict(set_instance_policies_one_of_set_instance_policy_key_create_import_access_resources_item_model_json)
        assert set_instance_policies_one_of_set_instance_policy_key_create_import_access_resources_item_model != False

        # Construct a model instance of SetInstancePoliciesOneOfSetInstancePolicyKeyCreateImportAccessResourcesItem by calling from_dict on the json representation
        set_instance_policies_one_of_set_instance_policy_key_create_import_access_resources_item_model_dict = SetInstancePoliciesOneOfSetInstancePolicyKeyCreateImportAccessResourcesItem.from_dict(set_instance_policies_one_of_set_instance_policy_key_create_import_access_resources_item_model_json).__dict__
        set_instance_policies_one_of_set_instance_policy_key_create_import_access_resources_item_model2 = SetInstancePoliciesOneOfSetInstancePolicyKeyCreateImportAccessResourcesItem(**set_instance_policies_one_of_set_instance_policy_key_create_import_access_resources_item_model_dict)

        # Verify the model instances are equivalent
        assert set_instance_policies_one_of_set_instance_policy_key_create_import_access_resources_item_model == set_instance_policies_one_of_set_instance_policy_key_create_import_access_resources_item_model2

        # Convert model instance back to dict and verify no loss of data
        set_instance_policies_one_of_set_instance_policy_key_create_import_access_resources_item_model_json2 = set_instance_policies_one_of_set_instance_policy_key_create_import_access_resources_item_model.to_dict()
        assert set_instance_policies_one_of_set_instance_policy_key_create_import_access_resources_item_model_json2 == set_instance_policies_one_of_set_instance_policy_key_create_import_access_resources_item_model_json
...
class TestModel_SetInstancePoliciesOneOfSetInstancePolicyMetricsResourcesItem:
    ...
    def test_set_instance_policies_one_of_set_instance_policy_metrics_resources_item_serialization(self):
        """
        ...
        set_instance_policies_one_of_set_instance_policy_metrics_resources_item_model_json['policy_data'] = metrics_properties_model
        ...
        set_instance_policies_one_of_set_instance_policy_metrics_resources_item_model = SetInstancePoliciesOneOfSetInstancePolicyMetricsResourcesItem.from_dict(set_instance_policies_one_of_set_instance_policy_metrics_resources_item_model_json)
        assert set_instance_policies_one_of_set_instance_policy_metrics_resources_item_model != False

        # Construct a model instance of SetInstancePoliciesOneOfSetInstancePolicyMetricsResourcesItem by calling from_dict on the json representation
        set_instance_policies_one_of_set_instance_policy_metrics_resources_item_model_dict = SetInstancePoliciesOneOfSetInstancePolicyMetricsResourcesItem.from_dict(set_instance_policies_one_of_set_instance_policy_metrics_resources_item_model_json).__dict__
        set_instance_policies_one_of_set_instance_policy_metrics_resources_item_model2 = SetInstancePoliciesOneOfSetInstancePolicyMetricsResourcesItem(**set_instance_policies_one_of_set_instance_policy_metrics_resources_item_model_dict)

        # Verify the model instances are equivalent
        assert set_instance_policies_one_of_set_instance_policy_metrics_resources_item_model == set_instance_policies_one_of_set_instance_policy_metrics_resources_item_model2

        # Convert model instance back to dict and verify no loss of data
        set_instance_policies_one_of_set_instance_policy_metrics_resources_item_model_json2 = set_instance_policies_one_of_set_instance_policy_metrics_resources_item_model.to_dict()
        assert set_instance_policies_one_of_set_instance_policy_metrics_resources_item_model_json2 == set_instance_policies_one_of_set_instance_policy_metrics_resources_item_model_json
...
class TestModel_SetInstancePoliciesOneOfSetInstancePolicyRotationResourcesItem:
    ...
    def test_set_instance_policies_one_of_set_instance_policy_rotation_resources_item_serialization(self):
        """
        ...
        set_instance_policies_one_of_set_instance_policy_rotation_resources_item_model_json['policy_data'] = instance_policy_rotation_policy_data_model
        ...
        set_instance_policies_one_of_set_instance_policy_rotation_resources_item_model = SetInstancePoliciesOneOfSetInstancePolicyRotationResourcesItem.from_dict(set_instance_policies_one_of_set_instance_policy_rotation_resources_item_model_json)
        assert set_instance_policies_one_of_set_instance_policy_rotation_resources_item_model != False

        # Construct a model instance of SetInstancePoliciesOneOfSetInstancePolicyRotationResourcesItem by calling from_dict on the json representation
        set_instance_policies_one_of_set_instance_policy_rotation_resources_item_model_dict = SetInstancePoliciesOneOfSetInstancePolicyRotationResourcesItem.from_dict(set_instance_policies_one_of_set_instance_policy_rotation_resources_item_model_json).__dict__
        set_instance_policies_one_of_set_instance_policy_rotation_resources_item_model2 = SetInstancePoliciesOneOfSetInstancePolicyRotationResourcesItem(**set_instance_policies_one_of_set_instance_policy_rotation_resources_item_model_dict)

        # Verify the model instances are equivalent
        assert set_instance_policies_one_of_set_instance_policy_rotation_resources_item_model == set_instance_policies_one_of_set_instance_policy_rotation_resources_item_model2

        # Convert model instance back to dict and verify no loss of data
        set_instance_policies_one_of_set_instance_policy_rotation_resources_item_model_json2 = set_instance_policies_one_of_set_instance_policy_rotation_resources_item_model.to_dict()
        assert set_instance_policies_one_of_set_instance_policy_rotation_resources_item_model_json2 == set_instance_policies_one_of_set_instance_policy_rotation_resources_item_model_json
...
class TestModel_SetInstancePolicyDualAuthDeleteResourcesItem:
    ...
    def test_set_instance_policy_dual_auth_delete_resources_item_serialization(self):
        ...
        set_instance_policy_dual_auth_delete_resources_item_model_json['policy_data'] = dual_auth_delete_properties_model
        ...
        set_instance_policy_dual_auth_delete_resources_item_model = SetInstancePolicyDualAuthDeleteResourcesItem.from_dict(set_instance_policy_dual_auth_delete_resources_item_model_json)
        assert set_instance_policy_dual_auth_delete_resources_item_model != False

        # Construct a model instance of SetInstancePolicyDualAuthDeleteResourcesItem by calling from_dict on the json representation
        set_instance_policy_dual_auth_delete_resources_item_model_dict = SetInstancePolicyDualAuthDeleteResourcesItem.from_dict(set_instance_policy_dual_auth_delete_resources_item_model_json).__dict__
        set_instance_policy_dual_auth_delete_resources_item_model2 = SetInstancePolicyDualAuthDeleteResourcesItem(**set_instance_policy_dual_auth_delete_resources_item_model_dict)

        # Verify the model instances are equivalent
        assert set_instance_policy_dual_auth_delete_resources_item_model == set_instance_policy_dual_auth_delete_resources_item_model2

        # Convert model instance back to dict and verify no loss of data
        set_instance_policy_dual_auth_delete_resources_item_model_json2 = set_instance_policy_dual_auth_delete_resources_item_model.to_dict()
        assert set_instance_policy_dual_auth_delete_resources_item_model_json2 == set_instance_policy_dual_auth_delete_resources_item_model_json
...
class TestModel_SetMultipleInstancePoliciesResourcesItem:
    ...
    def test_set_multiple_instance_policies_resources_item_serialization(self):
        ...
        set_multiple_instance_policies_resources_item_policy_data_attributes_model = {}  # SetMultipleInstancePoliciesResourcesItemPolicyDataAttributes
        set_multiple_instance_policies_resources_item_policy_data_attributes_model['allowed_network'] = 'public-and-private'
        set_multiple_instance_policies_resources_item_policy_data_attributes_model['allowed_ip'] = ['10.1.0.0/32', '10.0.0.0/24', '192.0.2.0/32', '198.51.100.0/24', '2001:db8::/60']
        ...
        set_multiple_instance_policies_resources_item_policy_data_model = {}  # SetMultipleInstancePoliciesResourcesItemPolicyData
        set_multiple_instance_policies_resources_item_policy_data_model['enabled'] = True
        set_multiple_instance_policies_resources_item_policy_data_model['attributes'] = set_multiple_instance_policies_resources_item_policy_data_attributes_model
        ...
        set_multiple_instance_policies_resources_item_model_json['policy_data'] = set_multiple_instance_policies_resources_item_policy_data_model

        # Construct a model instance of SetMultipleInstancePoliciesResourcesItem by calling from_dict on the json representation
        set_multiple_instance_policies_resources_item_model = SetMultipleInstancePoliciesResourcesItem.from_dict(set_multiple_instance_policies_resources_item_model_json)
        assert set_multiple_instance_policies_resources_item_model != False

        # Construct a model instance of SetMultipleInstancePoliciesResourcesItem by calling from_dict on the json representation
        set_multiple_instance_policies_resources_item_model_dict = SetMultipleInstancePoliciesResourcesItem.from_dict(set_multiple_instance_policies_resources_item_model_json).__dict__
        set_multiple_instance_policies_resources_item_model2 = SetMultipleInstancePoliciesResourcesItem(**set_multiple_instance_policies_resources_item_model_dict)

        # Verify the model instances are equivalent
        assert set_multiple_instance_policies_resources_item_model == set_multiple_instance_policies_resources_item_model2

        # Convert model instance back to dict and verify no loss of data
        set_multiple_instance_policies_resources_item_model_json2 = set_multiple_instance_policies_resources_item_model.to_dict()
        assert set_multiple_instance_policies_resources_item_model_json2 == set_multiple_instance_policies_resources_item_model_json
...
class TestModel_SetMultipleInstancePoliciesResourcesItemPolicyData:
    ...
    def test_set_multiple_instance_policies_resources_item_policy_data_serialization(self):
        """
        ...
        set_multiple_instance_policies_resources_item_policy_data_model_json['attributes'] = set_multiple_instance_policies_resources_item_policy_data_attributes_model
        ...
        set_multiple_instance_policies_resources_item_policy_data_model = SetMultipleInstancePoliciesResourcesItemPolicyData.from_dict(set_multiple_instance_policies_resources_item_policy_data_model_json)
        assert set_multiple_instance_policies_resources_item_policy_data_model != False

        # Construct a model instance of SetMultipleInstancePoliciesResourcesItemPolicyData by calling from_dict on the json representation
        set_multiple_instance_policies_resources_item_policy_data_model_dict = SetMultipleInstancePoliciesResourcesItemPolicyData.from_dict(set_multiple_instance_policies_resources_item_policy_data_model_json).__dict__
        set_multiple_instance_policies_resources_item_policy_data_model2 = SetMultipleInstancePoliciesResourcesItemPolicyData(**set_multiple_instance_policies_resources_item_policy_data_model_dict)

        # Verify the model instances are equivalent
        assert set_multiple_instance_policies_resources_item_policy_data_model == set_multiple_instance_policies_resources_item_policy_data_model2

        # Convert model instance back to dict and verify no loss of data
        set_multiple_instance_policies_resources_item_policy_data_model_json2 = set_multiple_instance_policies_resources_item_policy_data_model.to_dict()
        assert set_multiple_instance_policies_resources_item_policy_data_model_json2 == set_multiple_instance_policies_resources_item_policy_data_model_json
...
class TestModel_SetMultipleInstancePoliciesResourcesItemPolicyDataAttributes:
    ...
    def test_set_multiple_instance_policies_resources_item_policy_data_attributes_serialization(self):
        """
        ...
        set_multiple_instance_policies_resources_item_policy_data_attributes_model_json['allowed_network'] = 'public-and-private'
        set_multiple_instance_policies_resources_item_policy_data_attributes_model_json['allowed_ip'] = ['10.1.0.0/32', '10.0.0.0/24', '192.0.2.0/32', '198.51.100.0/24', '2001:db8::/60']
        ...
        set_multiple_instance_policies_resources_item_policy_data_attributes_model = SetMultipleInstancePoliciesResourcesItemPolicyDataAttributes.from_dict(set_multiple_instance_policies_resources_item_policy_data_attributes_model_json)
        assert set_multiple_instance_policies_resources_item_policy_data_attributes_model != False

        # Construct a model instance of SetMultipleInstancePoliciesResourcesItemPolicyDataAttributes by calling from_dict on the json representation
        set_multiple_instance_policies_resources_item_policy_data_attributes_model_dict = SetMultipleInstancePoliciesResourcesItemPolicyDataAttributes.from_dict(set_multiple_instance_policies_resources_item_policy_data_attributes_model_json).__dict__
        set_multiple_instance_policies_resources_item_policy_data_attributes_model2 = SetMultipleInstancePoliciesResourcesItemPolicyDataAttributes(**set_multiple_instance_policies_resources_item_policy_data_attributes_model_dict)

        # Verify the model instances are equivalent
        assert set_multiple_instance_policies_resources_item_policy_data_attributes_model == set_multiple_instance_policies_resources_item_policy_data_attributes_model2

        # Convert model instance back to dict and verify no loss of data
        set_multiple_instance_policies_resources_item_policy_data_attributes_model_json2 = set_multiple_instance_policies_resources_item_policy_data_attributes_model.to_dict()
        assert set_multiple_instance_policies_resources_item_policy_data_attributes_model_json2 == set_multiple_instance_policies_resources_item_policy_data_attributes_model_json
...
class TestModel_SetMultipleKeyPoliciesResource:
    ...
    def test_set_multiple_key_policies_resource_serialization(self):
        ...
        set_multiple_key_policies_resource_model_json['dualAuthDelete'] = key_policy_dual_auth_delete_dual_auth_delete_model
        ...
        set_multiple_key_policies_resource_model = SetMultipleKeyPoliciesResource.from_dict(set_multiple_key_policies_resource_model_json)
        assert set_multiple_key_policies_resource_model != False

        # Construct a model instance of SetMultipleKeyPoliciesResource by calling from_dict on the json representation
        set_multiple_key_policies_resource_model_dict = SetMultipleKeyPoliciesResource.from_dict(set_multiple_key_policies_resource_model_json).__dict__
        set_multiple_key_policies_resource_model2 = SetMultipleKeyPoliciesResource(**set_multiple_key_policies_resource_model_dict)
...
class TestModel_UnwrapKeyResponseBody:
    ...
    def test_unwrap_key_response_body_serialization(self):
        ...
        # Construct a model instance of UnwrapKeyResponseBody by calling from_dict on the json representation
        unwrap_key_response_body_model_dict = UnwrapKeyResponseBody.from_dict(unwrap_key_response_body_model_json).__dict__
...
class TestModel_WrappedKeyVersionKeyVersion:
    ...
    def test_wrapped_key_version_key_version_serialization(self):
        ...
        wrapped_key_version_key_version_model = WrappedKeyVersionKeyVersion.from_dict(wrapped_key_version_key_version_model_json)
        assert wrapped_key_version_key_version_model != False

        # Construct a model instance of WrappedKeyVersionKeyVersion by calling from_dict on the json representation
        wrapped_key_version_key_version_model_dict = WrappedKeyVersionKeyVersion.from_dict(wrapped_key_version_key_version_model_json).__dict__
        wrapped_key_version_key_version_model2 = WrappedKeyVersionKeyVersion(**wrapped_key_version_key_version_model_dict)
...
class TestModel_CollectionMetadataOneOfCollectionMetadata:
    ...
    def test_collection_metadata_one_of_collection_metadata_serialization(self):
        ...
        collection_metadata_one_of_collection_metadata_model_json['collectionType'] = 'application/vnd.ibm.kms.allowed_ip_metadata+json'
        ...
        collection_metadata_one_of_collection_metadata_model = CollectionMetadataOneOfCollectionMetadata.from_dict(collection_metadata_one_of_collection_metadata_model_json)
        assert collection_metadata_one_of_collection_metadata_model != False

        # Construct a model instance of CollectionMetadataOneOfCollectionMetadata by calling from_dict on the json representation
        collection_metadata_one_of_collection_metadata_model_dict = CollectionMetadataOneOfCollectionMetadata.from_dict(collection_metadata_one_of_collection_metadata_model_json).__dict__
        collection_metadata_one_of_collection_metadata_model2 = CollectionMetadataOneOfCollectionMetadata(**collection_metadata_one_of_collection_metadata_model_dict)

        # Verify the model instances are equivalent
        assert collection_metadata_one_of_collection_metadata_model == collection_metadata_one_of_collection_metadata_model2

        # Convert model instance back to dict and verify no loss of data
        collection_metadata_one_of_collection_metadata_model_json2 = collection_metadata_one_of_collection_metadata_model.to_dict()
        assert collection_metadata_one_of_collection_metadata_model_json2 == collection_metadata_one_of_collection_metadata_model_json
...
class TestModel_GetInstancePoliciesOneOfGetInstancePolicyAllowedIP:
    ...
    def test_get_instance_policies_one_of_get_instance_policy_allowed_ip_serialization(self):
        """
        ...
        get_instance_policy_allowed_ip_resources_item_model['policy_data'] = get_instance_policy_allowed_ip_resources_item_policy_data_model
        ...
        get_instance_policies_one_of_get_instance_policy_allowed_ip_model_json['metadata'] = collection_metadata_one_of_model
        get_instance_policies_one_of_get_instance_policy_allowed_ip_model_json['resources'] = [get_instance_policy_allowed_ip_resources_item_model]
        ...
        get_instance_policies_one_of_get_instance_policy_allowed_ip_model = GetInstancePoliciesOneOfGetInstancePolicyAllowedIP.from_dict(get_instance_policies_one_of_get_instance_policy_allowed_ip_model_json)
        assert get_instance_policies_one_of_get_instance_policy_allowed_ip_model != False

        # Construct a model instance of GetInstancePoliciesOneOfGetInstancePolicyAllowedIP by calling from_dict on the json representation
        get_instance_policies_one_of_get_instance_policy_allowed_ip_model_dict = GetInstancePoliciesOneOfGetInstancePolicyAllowedIP.from_dict(get_instance_policies_one_of_get_instance_policy_allowed_ip_model_json).__dict__
        get_instance_policies_one_of_get_instance_policy_allowed_ip_model2 = GetInstancePoliciesOneOfGetInstancePolicyAllowedIP(**get_instance_policies_one_of_get_instance_policy_allowed_ip_model_dict)

        # Verify the model instances are equivalent
        assert get_instance_policies_one_of_get_instance_policy_allowed_ip_model == get_instance_policies_one_of_get_instance_policy_allowed_ip_model2

        # Convert model instance back to dict and verify no loss of data
        get_instance_policies_one_of_get_instance_policy_allowed_ip_model_json2 = get_instance_policies_one_of_get_instance_policy_allowed_ip_model.to_dict()
        assert get_instance_policies_one_of_get_instance_policy_allowed_ip_model_json2 == get_instance_policies_one_of_get_instance_policy_allowed_ip_model_json
...
class TestModel_GetInstancePoliciesOneOfGetInstancePolicyAllowedNetwork:
    ...
    def test_get_instance_policies_one_of_get_instance_policy_allowed_network_serialization(self):
        """
        ...
        get_instance_policies_one_of_get_instance_policy_allowed_network_resources_item_model = {}  # GetInstancePoliciesOneOfGetInstancePolicyAllowedNetworkResourcesItem
        get_instance_policies_one_of_get_instance_policy_allowed_network_resources_item_model['policy_type'] = 'testString'
        get_instance_policies_one_of_get_instance_policy_allowed_network_resources_item_model['policy_data'] = get_instance_policies_one_of_get_instance_policy_allowed_network_resources_item_policy_data_model
        ...
        get_instance_policies_one_of_get_instance_policy_allowed_network_model_json['metadata'] = collection_metadata_one_of_model
        get_instance_policies_one_of_get_instance_policy_allowed_network_model_json['resources'] = [get_instance_policies_one_of_get_instance_policy_allowed_network_resources_item_model]
        ...
        get_instance_policies_one_of_get_instance_policy_allowed_network_model = GetInstancePoliciesOneOfGetInstancePolicyAllowedNetwork.from_dict(get_instance_policies_one_of_get_instance_policy_allowed_network_model_json)
        assert get_instance_policies_one_of_get_instance_policy_allowed_network_model != False

        # Construct a model instance of GetInstancePoliciesOneOfGetInstancePolicyAllowedNetwork by calling from_dict on the json representation
        get_instance_policies_one_of_get_instance_policy_allowed_network_model_dict = GetInstancePoliciesOneOfGetInstancePolicyAllowedNetwork.from_dict(get_instance_policies_one_of_get_instance_policy_allowed_network_model_json).__dict__
        get_instance_policies_one_of_get_instance_policy_allowed_network_model2 = GetInstancePoliciesOneOfGetInstancePolicyAllowedNetwork(**get_instance_policies_one_of_get_instance_policy_allowed_network_model_dict)

        # Verify the model instances are equivalent
        assert get_instance_policies_one_of_get_instance_policy_allowed_network_model == get_instance_policies_one_of_get_instance_policy_allowed_network_model2

        # Convert model instance back to dict and verify no loss of data
        get_instance_policies_one_of_get_instance_policy_allowed_network_model_json2 = get_instance_policies_one_of_get_instance_policy_allowed_network_model.to_dict()
        assert get_instance_policies_one_of_get_instance_policy_allowed_network_model_json2 == get_instance_policies_one_of_get_instance_policy_allowed_network_model_json
...
class TestModel_GetInstancePoliciesOneOfGetInstancePolicyDualAuthDelete:
    ...
    def test_get_instance_policies_one_of_get_instance_policy_dual_auth_delete_serialization(self):
        """
        ...
        get_instance_policies_one_of_get_instance_policy_dual_auth_delete_model_json['metadata'] = collection_metadata_one_of_model
        get_instance_policies_one_of_get_instance_policy_dual_auth_delete_model_json['resources'] = [get_instance_policy_dual_auth_delete_resources_item_model]
        ...
        get_instance_policies_one_of_get_instance_policy_dual_auth_delete_model = GetInstancePoliciesOneOfGetInstancePolicyDualAuthDelete.from_dict(get_instance_policies_one_of_get_instance_policy_dual_auth_delete_model_json)
        assert get_instance_policies_one_of_get_instance_policy_dual_auth_delete_model != False

        # Construct a model instance of GetInstancePoliciesOneOfGetInstancePolicyDualAuthDelete by calling from_dict on the json representation
        get_instance_policies_one_of_get_instance_policy_dual_auth_delete_model_dict = GetInstancePoliciesOneOfGetInstancePolicyDualAuthDelete.from_dict(get_instance_policies_one_of_get_instance_policy_dual_auth_delete_model_json).__dict__
        get_instance_policies_one_of_get_instance_policy_dual_auth_delete_model2 = GetInstancePoliciesOneOfGetInstancePolicyDualAuthDelete(**get_instance_policies_one_of_get_instance_policy_dual_auth_delete_model_dict)

        # Verify the model instances are equivalent
        assert get_instance_policies_one_of_get_instance_policy_dual_auth_delete_model == get_instance_policies_one_of_get_instance_policy_dual_auth_delete_model2

        # Convert model instance back to dict and verify no loss of data
        get_instance_policies_one_of_get_instance_policy_dual_auth_delete_model_json2 = get_instance_policies_one_of_get_instance_policy_dual_auth_delete_model.to_dict()
        assert get_instance_policies_one_of_get_instance_policy_dual_auth_delete_model_json2 == get_instance_policies_one_of_get_instance_policy_dual_auth_delete_model_json
...
class TestModel_GetInstancePoliciesOneOfGetInstancePolicyKeyCreateImportAccess:
    ...
    def test_get_instance_policies_one_of_get_instance_policy_key_create_import_access_serialization(self):
        """
        ...
        get_instance_policies_one_of_get_instance_policy_key_create_import_access_resources_item_model = {}  # GetInstancePoliciesOneOfGetInstancePolicyKeyCreateImportAccessResourcesItem
        get_instance_policies_one_of_get_instance_policy_key_create_import_access_resources_item_model['policy_type'] = 'testString'
        get_instance_policies_one_of_get_instance_policy_key_create_import_access_resources_item_model['policy_data'] = get_instance_policies_one_of_get_instance_policy_key_create_import_access_resources_item_policy_data_model
        ...
        get_instance_policies_one_of_get_instance_policy_key_create_import_access_model_json['metadata'] = collection_metadata_one_of_model
        get_instance_policies_one_of_get_instance_policy_key_create_import_access_model_json['resources'] = [get_instance_policies_one_of_get_instance_policy_key_create_import_access_resources_item_model]
        ...
        get_instance_policies_one_of_get_instance_policy_key_create_import_access_model = GetInstancePoliciesOneOfGetInstancePolicyKeyCreateImportAccess.from_dict(get_instance_policies_one_of_get_instance_policy_key_create_import_access_model_json)
        assert get_instance_policies_one_of_get_instance_policy_key_create_import_access_model != False

        # Construct a model instance of GetInstancePoliciesOneOfGetInstancePolicyKeyCreateImportAccess by calling from_dict on the json representation
        get_instance_policies_one_of_get_instance_policy_key_create_import_access_model_dict = GetInstancePoliciesOneOfGetInstancePolicyKeyCreateImportAccess.from_dict(get_instance_policies_one_of_get_instance_policy_key_create_import_access_model_json).__dict__
        get_instance_policies_one_of_get_instance_policy_key_create_import_access_model2 = GetInstancePoliciesOneOfGetInstancePolicyKeyCreateImportAccess(**get_instance_policies_one_of_get_instance_policy_key_create_import_access_model_dict)

        # Verify the model instances are equivalent
        assert get_instance_policies_one_of_get_instance_policy_key_create_import_access_model == get_instance_policies_one_of_get_instance_policy_key_create_import_access_model2

        # Convert model instance back to dict and verify no loss of data
        get_instance_policies_one_of_get_instance_policy_key_create_import_access_model_json2 = get_instance_policies_one_of_get_instance_policy_key_create_import_access_model.to_dict()
        assert get_instance_policies_one_of_get_instance_policy_key_create_import_access_model_json2 == get_instance_policies_one_of_get_instance_policy_key_create_import_access_model_json
...
class TestModel_GetInstancePoliciesOneOfGetInstancePolicyMetrics:
    ...
    def test_get_instance_policies_one_of_get_instance_policy_metrics_serialization(self):
        """
        ...
        get_instance_policies_one_of_get_instance_policy_metrics_model_json['metadata'] = collection_metadata_one_of_model
        get_instance_policies_one_of_get_instance_policy_metrics_model_json['resources'] = [get_instance_policy_metrics_resources_item_model]
        ...
        get_instance_policies_one_of_get_instance_policy_metrics_model = GetInstancePoliciesOneOfGetInstancePolicyMetrics.from_dict(get_instance_policies_one_of_get_instance_policy_metrics_model_json)
        assert get_instance_policies_one_of_get_instance_policy_metrics_model != False

        # Construct a model instance of GetInstancePoliciesOneOfGetInstancePolicyMetrics by calling from_dict on the json representation
        get_instance_policies_one_of_get_instance_policy_metrics_model_dict = GetInstancePoliciesOneOfGetInstancePolicyMetrics.from_dict(get_instance_policies_one_of_get_instance_policy_metrics_model_json).__dict__
        get_instance_policies_one_of_get_instance_policy_metrics_model2 = GetInstancePoliciesOneOfGetInstancePolicyMetrics(**get_instance_policies_one_of_get_instance_policy_metrics_model_dict)

        # Verify the model instances are equivalent
        assert get_instance_policies_one_of_get_instance_policy_metrics_model == get_instance_policies_one_of_get_instance_policy_metrics_model2

        # Convert model instance back to dict and verify no loss of data
        get_instance_policies_one_of_get_instance_policy_metrics_model_json2 = get_instance_policies_one_of_get_instance_policy_metrics_model.to_dict()
        assert get_instance_policies_one_of_get_instance_policy_metrics_model_json2 == get_instance_policies_one_of_get_instance_policy_metrics_model_json
...
class TestModel_GetInstancePoliciesOneOfGetInstancePolicyRotation:
    ...
    def test_get_instance_policies_one_of_get_instance_policy_rotation_serialization(self):
        """
        ...
        get_instance_policy_rotation_resources_item_model['policy_data'] = get_instance_policy_rotation_resources_item_policy_data_model
        ...
        get_instance_policies_one_of_get_instance_policy_rotation_model_json['metadata'] = collection_metadata_one_of_model
        get_instance_policies_one_of_get_instance_policy_rotation_model_json['resources'] = [get_instance_policy_rotation_resources_item_model]
        ...
        get_instance_policies_one_of_get_instance_policy_rotation_model = GetInstancePoliciesOneOfGetInstancePolicyRotation.from_dict(get_instance_policies_one_of_get_instance_policy_rotation_model_json)
        assert get_instance_policies_one_of_get_instance_policy_rotation_model != False

        # Construct a model instance of GetInstancePoliciesOneOfGetInstancePolicyRotation by calling from_dict on the json representation
        get_instance_policies_one_of_get_instance_policy_rotation_model_dict = GetInstancePoliciesOneOfGetInstancePolicyRotation.from_dict(get_instance_policies_one_of_get_instance_policy_rotation_model_json).__dict__
        get_instance_policies_one_of_get_instance_policy_rotation_model2 = GetInstancePoliciesOneOfGetInstancePolicyRotation(**get_instance_policies_one_of_get_instance_policy_rotation_model_dict)

        # Verify the model instances are equivalent
        assert get_instance_policies_one_of_get_instance_policy_rotation_model == get_instance_policies_one_of_get_instance_policy_rotation_model2

        # Convert model instance back to dict and verify no loss of data
        get_instance_policies_one_of_get_instance_policy_rotation_model_json2 = get_instance_policies_one_of_get_instance_policy_rotation_model.to_dict()
        assert get_instance_policies_one_of_get_instance_policy_rotation_model_json2 == get_instance_policies_one_of_get_instance_policy_rotation_model_json
...
class TestModel_GetInstancePoliciesOneOfGetMultipleInstancePolicies:
    ...
    def test_get_instance_policies_one_of_get_multiple_instance_policies_serialization(self):
        """
        ...
        get_instance_policies_one_of_get_multiple_instance_policies_model_json['metadata'] = collection_metadata_one_of_model
        get_instance_policies_one_of_get_multiple_instance_policies_model_json['resources'] = [instance_policy_resource_model]
        ...
        get_instance_policies_one_of_get_multiple_instance_policies_model = GetInstancePoliciesOneOfGetMultipleInstancePolicies.from_dict(get_instance_policies_one_of_get_multiple_instance_policies_model_json)
        assert get_instance_policies_one_of_get_multiple_instance_policies_model != False

        # Construct a model instance of GetInstancePoliciesOneOfGetMultipleInstancePolicies by calling from_dict on the json representation
        get_instance_policies_one_of_get_multiple_instance_policies_model_dict = GetInstancePoliciesOneOfGetMultipleInstancePolicies.from_dict(get_instance_policies_one_of_get_multiple_instance_policies_model_json).__dict__
        get_instance_policies_one_of_get_multiple_instance_policies_model2 = GetInstancePoliciesOneOfGetMultipleInstancePolicies(**get_instance_policies_one_of_get_multiple_instance_policies_model_dict)

        # Verify the model instances are equivalent
        assert get_instance_policies_one_of_get_multiple_instance_policies_model == get_instance_policies_one_of_get_multiple_instance_policies_model2

        # Convert model instance back to dict and verify no loss of data
        get_instance_policies_one_of_get_multiple_instance_policies_model_json2 = get_instance_policies_one_of_get_multiple_instance_policies_model.to_dict()
        assert get_instance_policies_one_of_get_multiple_instance_policies_model_json2 == get_instance_policies_one_of_get_multiple_instance_policies_model_json
...
class TestModel_GetKeyPoliciesOneOfGetKeyPolicyDualAuthDelete:
    ...
    def test_get_key_policies_one_of_get_key_policy_dual_auth_delete_serialization(self):
        """
        ...
        get_key_policies_one_of_get_key_policy_dual_auth_delete_resources_item_model = {}  # GetKeyPoliciesOneOfGetKeyPolicyDualAuthDeleteResourcesItem
        get_key_policies_one_of_get_key_policy_dual_auth_delete_resources_item_model['type'] = 'application/vnd.ibm.kms.policy+json'
        get_key_policies_one_of_get_key_policy_dual_auth_delete_resources_item_model['dualAuthDelete'] = key_policy_dual_auth_delete_dual_auth_delete_model
        ...
        get_key_policies_one_of_get_key_policy_dual_auth_delete_model_json['resources'] = [get_key_policies_one_of_get_key_policy_dual_auth_delete_resources_item_model]
        ...
        get_key_policies_one_of_get_key_policy_dual_auth_delete_model = GetKeyPoliciesOneOfGetKeyPolicyDualAuthDelete.from_dict(get_key_policies_one_of_get_key_policy_dual_auth_delete_model_json)
        assert get_key_policies_one_of_get_key_policy_dual_auth_delete_model != False

        # Construct a model instance of GetKeyPoliciesOneOfGetKeyPolicyDualAuthDelete by calling from_dict on the json representation
        get_key_policies_one_of_get_key_policy_dual_auth_delete_model_dict = GetKeyPoliciesOneOfGetKeyPolicyDualAuthDelete.from_dict(get_key_policies_one_of_get_key_policy_dual_auth_delete_model_json).__dict__
        get_key_policies_one_of_get_key_policy_dual_auth_delete_model2 = GetKeyPoliciesOneOfGetKeyPolicyDualAuthDelete(**get_key_policies_one_of_get_key_policy_dual_auth_delete_model_dict)

        # Verify the model instances are equivalent
        assert get_key_policies_one_of_get_key_policy_dual_auth_delete_model == get_key_policies_one_of_get_key_policy_dual_auth_delete_model2

        # Convert model instance back to dict and verify no loss of data
        get_key_policies_one_of_get_key_policy_dual_auth_delete_model_json2 = get_key_policies_one_of_get_key_policy_dual_auth_delete_model.to_dict()
        assert get_key_policies_one_of_get_key_policy_dual_auth_delete_model_json2 == get_key_policies_one_of_get_key_policy_dual_auth_delete_model_json
...
class TestModel_GetKeyPoliciesOneOfGetKeyPolicyRotation:
    ...
    def test_get_key_policies_one_of_get_key_policy_rotation_serialization(self):
        ...
        get_key_policies_one_of_get_key_policy_rotation_model_json['resources'] = [get_key_policy_rotation_resources_item_model]

        # Construct a model instance of GetKeyPoliciesOneOfGetKeyPolicyRotation by calling from_dict on the json representation
        get_key_policies_one_of_get_key_policy_rotation_model = GetKeyPoliciesOneOfGetKeyPolicyRotation.from_dict(get_key_policies_one_of_get_key_policy_rotation_model_json)
        assert get_key_policies_one_of_get_key_policy_rotation_model != False

        # Construct a model instance of GetKeyPoliciesOneOfGetKeyPolicyRotation by calling from_dict on the json representation
        get_key_policies_one_of_get_key_policy_rotation_model_dict = GetKeyPoliciesOneOfGetKeyPolicyRotation.from_dict(get_key_policies_one_of_get_key_policy_rotation_model_json).__dict__
        get_key_policies_one_of_get_key_policy_rotation_model2 = GetKeyPoliciesOneOfGetKeyPolicyRotation(**get_key_policies_one_of_get_key_policy_rotation_model_dict)

        # Verify the model instances are equivalent
        assert get_key_policies_one_of_get_key_policy_rotation_model == get_key_policies_one_of_get_key_policy_rotation_model2

        # Convert model instance back to dict and verify no loss of data
        get_key_policies_one_of_get_key_policy_rotation_model_json2 = get_key_policies_one_of_get_key_policy_rotation_model.to_dict()
        assert get_key_policies_one_of_get_key_policy_rotation_model_json2 == get_key_policies_one_of_get_key_policy_rotation_model_json
...
class TestModel_GetKeyPoliciesOneOfGetMultipleKeyPolicies:
    ...
    def test_get_key_policies_one_of_get_multiple_key_policies_serialization(self):
        ...
        get_multiple_key_policies_resource_model['dualAuthDelete'] = get_multiple_key_policies_resource_dual_auth_delete_model
        ...
        get_key_policies_one_of_get_multiple_key_policies_model_json['resources'] = [get_multiple_key_policies_resource_model]

        # Construct a model instance of GetKeyPoliciesOneOfGetMultipleKeyPolicies by calling from_dict on the json representation
        get_key_policies_one_of_get_multiple_key_policies_model = GetKeyPoliciesOneOfGetMultipleKeyPolicies.from_dict(get_key_policies_one_of_get_multiple_key_policies_model_json)
        assert get_key_policies_one_of_get_multiple_key_policies_model != False

        # Construct a model instance of GetKeyPoliciesOneOfGetMultipleKeyPolicies by calling from_dict on the json representation
        get_key_policies_one_of_get_multiple_key_policies_model_dict = GetKeyPoliciesOneOfGetMultipleKeyPolicies.from_dict(get_key_policies_one_of_get_multiple_key_policies_model_json).__dict__
        get_key_policies_one_of_get_multiple_key_policies_model2 = GetKeyPoliciesOneOfGetMultipleKeyPolicies(**get_key_policies_one_of_get_multiple_key_policies_model_dict)

        # Verify the model instances are equivalent
        assert get_key_policies_one_of_get_multiple_key_policies_model == get_key_policies_one_of_get_multiple_key_policies_model2

        # Convert model instance back to dict and verify no loss of data
        get_key_policies_one_of_get_multiple_key_policies_model_json2 = get_key_policies_one_of_get_multiple_key_policies_model.to_dict()
        assert get_key_policies_one_of_get_multiple_key_policies_model_json2 == get_key_policies_one_of_get_multiple_key_policies_model_json
...
class TestModel_KMIPProfileDataBodyKMIPProfileDataNative:
    ...
    def test_kmip_profile_data_body_kmip_profile_data_native_serialization(self):
        ...
        kmip_profile_data_body_kmip_profile_data_native_model = KMIPProfileDataBodyKMIPProfileDataNative.from_dict(kmip_profile_data_body_kmip_profile_data_native_model_json)
        assert kmip_profile_data_body_kmip_profile_data_native_model != False

        # Construct a model instance of KMIPProfileDataBodyKMIPProfileDataNative by calling from_dict on the json representation
        kmip_profile_data_body_kmip_profile_data_native_model_dict = KMIPProfileDataBodyKMIPProfileDataNative.from_dict(kmip_profile_data_body_kmip_profile_data_native_model_json).__dict__
        kmip_profile_data_body_kmip_profile_data_native_model2 = KMIPProfileDataBodyKMIPProfileDataNative(**kmip_profile_data_body_kmip_profile_data_native_model_dict)

        # Verify the model instances are equivalent
        assert kmip_profile_data_body_kmip_profile_data_native_model == kmip_profile_data_body_kmip_profile_data_native_model2

        # Convert model instance back to dict and verify no loss of data
        kmip_profile_data_body_kmip_profile_data_native_model_json2 = kmip_profile_data_body_kmip_profile_data_native_model.to_dict()
        assert kmip_profile_data_body_kmip_profile_data_native_model_json2 == kmip_profile_data_body_kmip_profile_data_native_model_json
...
class TestModel_KeyActionOneOfResponseRewrapKeyResponseBody:
    ...
    def test_key_action_one_of_response_rewrap_key_response_body_serialization(self):
        ...
        key_action_one_of_response_rewrap_key_response_body_model = KeyActionOneOfResponseRewrapKeyResponseBody.from_dict(key_action_one_of_response_rewrap_key_response_body_model_json)
        assert key_action_one_of_response_rewrap_key_response_body_model != False

        # Construct a model instance of KeyActionOneOfResponseRewrapKeyResponseBody by calling from_dict on the json representation
        key_action_one_of_response_rewrap_key_response_body_model_dict = KeyActionOneOfResponseRewrapKeyResponseBody.from_dict(key_action_one_of_response_rewrap_key_response_body_model_json).__dict__
        key_action_one_of_response_rewrap_key_response_body_model2 = KeyActionOneOfResponseRewrapKeyResponseBody(**key_action_one_of_response_rewrap_key_response_body_model_dict)

        # Verify the model instances are equivalent
        assert key_action_one_of_response_rewrap_key_response_body_model == key_action_one_of_response_rewrap_key_response_body_model2

        # Convert model instance back to dict and verify no loss of data
        key_action_one_of_response_rewrap_key_response_body_model_json2 = key_action_one_of_response_rewrap_key_response_body_model.to_dict()
        assert key_action_one_of_response_rewrap_key_response_body_model_json2 == key_action_one_of_response_rewrap_key_response_body_model_json
...
class TestModel_KeyActionOneOfResponseUnwrapKeyResponseBody:
    ...
    def test_key_action_one_of_response_unwrap_key_response_body_serialization(self):
        ...
        key_action_one_of_response_unwrap_key_response_body_model = KeyActionOneOfResponseUnwrapKeyResponseBody.from_dict(key_action_one_of_response_unwrap_key_response_body_model_json)
        assert key_action_one_of_response_unwrap_key_response_body_model != False

        # Construct a model instance of KeyActionOneOfResponseUnwrapKeyResponseBody by calling from_dict on the json representation
        key_action_one_of_response_unwrap_key_response_body_model_dict = KeyActionOneOfResponseUnwrapKeyResponseBody.from_dict(key_action_one_of_response_unwrap_key_response_body_model_json).__dict__
        key_action_one_of_response_unwrap_key_response_body_model2 = KeyActionOneOfResponseUnwrapKeyResponseBody(**key_action_one_of_response_unwrap_key_response_body_model_dict)

        # Verify the model instances are equivalent
        assert key_action_one_of_response_unwrap_key_response_body_model == key_action_one_of_response_unwrap_key_response_body_model2

        # Convert model instance back to dict and verify no loss of data
        key_action_one_of_response_unwrap_key_response_body_model_json2 = key_action_one_of_response_unwrap_key_response_body_model.to_dict()
        assert key_action_one_of_response_unwrap_key_response_body_model_json2 == key_action_one_of_response_unwrap_key_response_body_model_json
...
class TestModel_KeyActionOneOfResponseWrapKeyResponseBody:
    ...
    def test_key_action_one_of_response_wrap_key_response_body_serialization(self):
        ...
        key_action_one_of_response_wrap_key_response_body_model = KeyActionOneOfResponseWrapKeyResponseBody.from_dict(key_action_one_of_response_wrap_key_response_body_model_json)
        assert key_action_one_of_response_wrap_key_response_body_model != False

        # Construct a model instance of KeyActionOneOfResponseWrapKeyResponseBody by calling from_dict on the json representation
        key_action_one_of_response_wrap_key_response_body_model_dict = KeyActionOneOfResponseWrapKeyResponseBody.from_dict(key_action_one_of_response_wrap_key_response_body_model_json).__dict__
        key_action_one_of_response_wrap_key_response_body_model2 = KeyActionOneOfResponseWrapKeyResponseBody(**key_action_one_of_response_wrap_key_response_body_model_dict)

        # Verify the model instances are equivalent
        assert key_action_one_of_response_wrap_key_response_body_model == key_action_one_of_response_wrap_key_response_body_model2

        # Convert model instance back to dict and verify no loss of data
        key_action_one_of_response_wrap_key_response_body_model_json2 = key_action_one_of_response_wrap_key_response_body_model.to_dict()
        assert key_action_one_of_response_wrap_key_response_body_model_json2 == key_action_one_of_response_wrap_key_response_body_model_json
...
class TestModel_ListCollectionMetadataCollectionMetadata:
    ...
    def test_list_collection_metadata_collection_metadata_serialization(self):
        ...
        list_collection_metadata_collection_metadata_model_json['collectionType'] = 'application/vnd.ibm.kms.allowed_ip_metadata+json'
        ...
        list_collection_metadata_collection_metadata_model = ListCollectionMetadataCollectionMetadata.from_dict(list_collection_metadata_collection_metadata_model_json)
        assert list_collection_metadata_collection_metadata_model != False

        # Construct a model instance of ListCollectionMetadataCollectionMetadata by calling from_dict on the json representation
        list_collection_metadata_collection_metadata_model_dict = ListCollectionMetadataCollectionMetadata.from_dict(list_collection_metadata_collection_metadata_model_json).__dict__
        list_collection_metadata_collection_metadata_model2 = ListCollectionMetadataCollectionMetadata(**list_collection_metadata_collection_metadata_model_dict)

        # Verify the model instances are equivalent
        assert list_collection_metadata_collection_metadata_model == list_collection_metadata_collection_metadata_model2

        # Convert model instance back to dict and verify no loss of data
        list_collection_metadata_collection_metadata_model_json2 = list_collection_metadata_collection_metadata_model.to_dict()
        assert list_collection_metadata_collection_metadata_model_json2 == list_collection_metadata_collection_metadata_model_json
...
class TestModel_ListCollectionMetadataCollectionMetadataWithTotalCount:
    ...
    def test_list_collection_metadata_collection_metadata_with_total_count_serialization(self):
        """
        ...
        list_collection_metadata_collection_metadata_with_total_count_model_json['collectionType'] = 'application/vnd.ibm.kms.allowed_ip_metadata+json'
        ...
        list_collection_metadata_collection_metadata_with_total_count_model = ListCollectionMetadataCollectionMetadataWithTotalCount.from_dict(list_collection_metadata_collection_metadata_with_total_count_model_json)
        assert list_collection_metadata_collection_metadata_with_total_count_model != False

        # Construct a model instance of ListCollectionMetadataCollectionMetadataWithTotalCount by calling from_dict on the json representation
        list_collection_metadata_collection_metadata_with_total_count_model_dict = ListCollectionMetadataCollectionMetadataWithTotalCount.from_dict(list_collection_metadata_collection_metadata_with_total_count_model_json).__dict__
        list_collection_metadata_collection_metadata_with_total_count_model2 = ListCollectionMetadataCollectionMetadataWithTotalCount(**list_collection_metadata_collection_metadata_with_total_count_model_dict)

        # Verify the model instances are equivalent
        assert list_collection_metadata_collection_metadata_with_total_count_model == list_collection_metadata_collection_metadata_with_total_count_model2

        # Convert model instance back to dict and verify no loss of data
        list_collection_metadata_collection_metadata_with_total_count_model_json2 = list_collection_metadata_collection_metadata_with_total_count_model.to_dict()
        assert list_collection_metadata_collection_metadata_with_total_count_model_json2 == list_collection_metadata_collection_metadata_with_total_count_model_json
...
class TestModel_SetInstancePoliciesOneOfSetInstancePolicyAllowedIP:
    ...
    def test_set_instance_policies_one_of_set_instance_policy_allowed_ip_serialization(self):
        """
        ...
        set_instance_policies_one_of_set_instance_policy_allowed_ip_resources_item_model = {}  # SetInstancePoliciesOneOfSetInstancePolicyAllowedIPResourcesItem
        set_instance_policies_one_of_set_instance_policy_allowed_ip_resources_item_model['policy_type'] = 'allowedIP'
        set_instance_policies_one_of_set_instance_policy_allowed_ip_resources_item_model['policy_data'] = instance_policy_allowed_ip_policy_data_model
        ...
        set_instance_policies_one_of_set_instance_policy_allowed_ip_model_json['resources'] = [set_instance_policies_one_of_set_instance_policy_allowed_ip_resources_item_model]
        ...
        set_instance_policies_one_of_set_instance_policy_allowed_ip_model = SetInstancePoliciesOneOfSetInstancePolicyAllowedIP.from_dict(set_instance_policies_one_of_set_instance_policy_allowed_ip_model_json)
        assert set_instance_policies_one_of_set_instance_policy_allowed_ip_model != False

        # Construct a model instance of SetInstancePoliciesOneOfSetInstancePolicyAllowedIP by calling from_dict on the json representation
        set_instance_policies_one_of_set_instance_policy_allowed_ip_model_dict = SetInstancePoliciesOneOfSetInstancePolicyAllowedIP.from_dict(set_instance_policies_one_of_set_instance_policy_allowed_ip_model_json).__dict__
        set_instance_policies_one_of_set_instance_policy_allowed_ip_model2 = SetInstancePoliciesOneOfSetInstancePolicyAllowedIP(**set_instance_policies_one_of_set_instance_policy_allowed_ip_model_dict)

        # Verify the model instances are equivalent
        assert set_instance_policies_one_of_set_instance_policy_allowed_ip_model == set_instance_policies_one_of_set_instance_policy_allowed_ip_model2

        # Convert model instance back to dict and verify no loss of data
        set_instance_policies_one_of_set_instance_policy_allowed_ip_model_json2 = set_instance_policies_one_of_set_instance_policy_allowed_ip_model.to_dict()
        assert set_instance_policies_one_of_set_instance_policy_allowed_ip_model_json2 == set_instance_policies_one_of_set_instance_policy_allowed_ip_model_json
...
class TestModel_SetInstancePoliciesOneOfSetInstancePolicyAllowedNetwork:
    ...
    def test_set_instance_policies_one_of_set_instance_policy_allowed_network_serialization(self):
        """
        ...
        set_instance_policies_one_of_set_instance_policy_allowed_network_resources_item_model = {}  # SetInstancePoliciesOneOfSetInstancePolicyAllowedNetworkResourcesItem
        set_instance_policies_one_of_set_instance_policy_allowed_network_resources_item_model['policy_type'] = 'allowedNetwork'
        set_instance_policies_one_of_set_instance_policy_allowed_network_resources_item_model['policy_data'] = instance_policy_allowed_network_policy_data_model
        ...
        set_instance_policies_one_of_set_instance_policy_allowed_network_model_json['metadata'] = collection_metadata_model
        set_instance_policies_one_of_set_instance_policy_allowed_network_model_json['resources'] = [set_instance_policies_one_of_set_instance_policy_allowed_network_resources_item_model]
        ...
        set_instance_policies_one_of_set_instance_policy_allowed_network_model = SetInstancePoliciesOneOfSetInstancePolicyAllowedNetwork.from_dict(set_instance_policies_one_of_set_instance_policy_allowed_network_model_json)
        assert set_instance_policies_one_of_set_instance_policy_allowed_network_model != False

        # Construct a model instance of SetInstancePoliciesOneOfSetInstancePolicyAllowedNetwork by calling from_dict on the json representation
        set_instance_policies_one_of_set_instance_policy_allowed_network_model_dict = SetInstancePoliciesOneOfSetInstancePolicyAllowedNetwork.from_dict(set_instance_policies_one_of_set_instance_policy_allowed_network_model_json).__dict__
        set_instance_policies_one_of_set_instance_policy_allowed_network_model2 = SetInstancePoliciesOneOfSetInstancePolicyAllowedNetwork(**set_instance_policies_one_of_set_instance_policy_allowed_network_model_dict)

        # Verify the model instances are equivalent
        assert set_instance_policies_one_of_set_instance_policy_allowed_network_model == set_instance_policies_one_of_set_instance_policy_allowed_network_model2

        # Convert model instance back to dict and verify no loss of data
        set_instance_policies_one_of_set_instance_policy_allowed_network_model_json2 = set_instance_policies_one_of_set_instance_policy_allowed_network_model.to_dict()
        assert set_instance_policies_one_of_set_instance_policy_allowed_network_model_json2 == set_instance_policies_one_of_set_instance_policy_allowed_network_model_json
...
class TestModel_SetInstancePoliciesOneOfSetInstancePolicyDualAuthDelete:
    ...
    def test_set_instance_policies_one_of_set_instance_policy_dual_auth_delete_serialization(self):
        """
        ...
        set_instance_policies_one_of_set_instance_policy_dual_auth_delete_model_json['metadata'] = collection_metadata_model
        set_instance_policies_one_of_set_instance_policy_dual_auth_delete_model_json['resources'] = [set_instance_policy_dual_auth_delete_resources_item_model]
        ...
        set_instance_policies_one_of_set_instance_policy_dual_auth_delete_model = SetInstancePoliciesOneOfSetInstancePolicyDualAuthDelete.from_dict(set_instance_policies_one_of_set_instance_policy_dual_auth_delete_model_json)
        assert set_instance_policies_one_of_set_instance_policy_dual_auth_delete_model != False

        # Construct a model instance of SetInstancePoliciesOneOfSetInstancePolicyDualAuthDelete by calling from_dict on the json representation
        set_instance_policies_one_of_set_instance_policy_dual_auth_delete_model_dict = SetInstancePoliciesOneOfSetInstancePolicyDualAuthDelete.from_dict(set_instance_policies_one_of_set_instance_policy_dual_auth_delete_model_json).__dict__
        set_instance_policies_one_of_set_instance_policy_dual_auth_delete_model2 = SetInstancePoliciesOneOfSetInstancePolicyDualAuthDelete(**set_instance_policies_one_of_set_instance_policy_dual_auth_delete_model_dict)

        # Verify the model instances are equivalent
        assert set_instance_policies_one_of_set_instance_policy_dual_auth_delete_model == set_instance_policies_one_of_set_instance_policy_dual_auth_delete_model2

        # Convert model instance back to dict and verify no loss of data
        set_instance_policies_one_of_set_instance_policy_dual_auth_delete_model_json2 = set_instance_policies_one_of_set_instance_policy_dual_auth_delete_model.to_dict()
        assert set_instance_policies_one_of_set_instance_policy_dual_auth_delete_model_json2 == set_instance_policies_one_of_set_instance_policy_dual_auth_delete_model_json
...
class TestModel_SetInstancePoliciesOneOfSetInstancePolicyKeyCreateImportAccess:
    ...
    def test_set_instance_policies_one_of_set_instance_policy_key_create_import_access_serialization(self):
        """
        ...
        set_instance_policies_one_of_set_instance_policy_key_create_import_access_resources_item_model = {}  # SetInstancePoliciesOneOfSetInstancePolicyKeyCreateImportAccessResourcesItem
        set_instance_policies_one_of_set_instance_policy_key_create_import_access_resources_item_model['policy_type'] = 'keyCreateImportAccess'
        set_instance_policies_one_of_set_instance_policy_key_create_import_access_resources_item_model['policy_data'] = instance_policy_key_create_import_access_policy_data_model
        ...
        set_instance_policies_one_of_set_instance_policy_key_create_import_access_model_json['metadata'] = collection_metadata_model
        set_instance_policies_one_of_set_instance_policy_key_create_import_access_model_json['resources'] = [set_instance_policies_one_of_set_instance_policy_key_create_import_access_resources_item_model]
        ...
        set_instance_policies_one_of_set_instance_policy_key_create_import_access_model = SetInstancePoliciesOneOfSetInstancePolicyKeyCreateImportAccess.from_dict(set_instance_policies_one_of_set_instance_policy_key_create_import_access_model_json)
        assert set_instance_policies_one_of_set_instance_policy_key_create_import_access_model != False

        # Construct a model instance of SetInstancePoliciesOneOfSetInstancePolicyKeyCreateImportAccess by calling from_dict on the json representation
        set_instance_policies_one_of_set_instance_policy_key_create_import_access_model_dict = SetInstancePoliciesOneOfSetInstancePolicyKeyCreateImportAccess.from_dict(set_instance_policies_one_of_set_instance_policy_key_create_import_access_model_json).__dict__
        set_instance_policies_one_of_set_instance_policy_key_create_import_access_model2 = SetInstancePoliciesOneOfSetInstancePolicyKeyCreateImportAccess(**set_instance_policies_one_of_set_instance_policy_key_create_import_access_model_dict)

        # Verify the model instances are equivalent
        assert set_instance_policies_one_of_set_instance_policy_key_create_import_access_model == set_instance_policies_one_of_set_instance_policy_key_create_import_access_model2

        # Convert model instance back to dict and verify no loss of data
        set_instance_policies_one_of_set_instance_policy_key_create_import_access_model_json2 = set_instance_policies_one_of_set_instance_policy_key_create_import_access_model.to_dict()
        assert set_instance_policies_one_of_set_instance_policy_key_create_import_access_model_json2 == set_instance_policies_one_of_set_instance_policy_key_create_import_access_model_json
...
class TestModel_SetInstancePoliciesOneOfSetInstancePolicyMetrics:
    ...
    def test_set_instance_policies_one_of_set_instance_policy_metrics_serialization(self):
        """
        ...
        set_instance_policies_one_of_set_instance_policy_metrics_resources_item_model = {}  # SetInstancePoliciesOneOfSetInstancePolicyMetricsResourcesItem
        set_instance_policies_one_of_set_instance_policy_metrics_resources_item_model['policy_type'] = 'metrics'
        set_instance_policies_one_of_set_instance_policy_metrics_resources_item_model['policy_data'] = metrics_properties_model
        ...
        set_instance_policies_one_of_set_instance_policy_metrics_model_json['resources'] = [set_instance_policies_one_of_set_instance_policy_metrics_resources_item_model]
        ...
        set_instance_policies_one_of_set_instance_policy_metrics_model = SetInstancePoliciesOneOfSetInstancePolicyMetrics.from_dict(set_instance_policies_one_of_set_instance_policy_metrics_model_json)
        assert set_instance_policies_one_of_set_instance_policy_metrics_model != False

        # Construct a model instance of SetInstancePoliciesOneOfSetInstancePolicyMetrics by calling from_dict on the json representation
        set_instance_policies_one_of_set_instance_policy_metrics_model_dict = SetInstancePoliciesOneOfSetInstancePolicyMetrics.from_dict(set_instance_policies_one_of_set_instance_policy_metrics_model_json).__dict__
        set_instance_policies_one_of_set_instance_policy_metrics_model2 = SetInstancePoliciesOneOfSetInstancePolicyMetrics(**set_instance_policies_one_of_set_instance_policy_metrics_model_dict)

        # Verify the model instances are equivalent
        assert set_instance_policies_one_of_set_instance_policy_metrics_model == set_instance_policies_one_of_set_instance_policy_metrics_model2

        # Convert model instance back to dict and verify no loss of data
        set_instance_policies_one_of_set_instance_policy_metrics_model_json2 = set_instance_policies_one_of_set_instance_policy_metrics_model.to_dict()
        assert set_instance_policies_one_of_set_instance_policy_metrics_model_json2 == set_instance_policies_one_of_set_instance_policy_metrics_model_json
...
class TestModel_SetInstancePoliciesOneOfSetInstancePolicyRotation:
    ...
    def test_set_instance_policies_one_of_set_instance_policy_rotation_serialization(self):
        """
        ...
        set_instance_policies_one_of_set_instance_policy_rotation_resources_item_model = {}  # SetInstancePoliciesOneOfSetInstancePolicyRotationResourcesItem
        set_instance_policies_one_of_set_instance_policy_rotation_resources_item_model['policy_type'] = 'rotation'
        set_instance_policies_one_of_set_instance_policy_rotation_resources_item_model['policy_data'] = instance_policy_rotation_policy_data_model
        ...
        set_instance_policies_one_of_set_instance_policy_rotation_model_json['resources'] = [set_instance_policies_one_of_set_instance_policy_rotation_resources_item_model]
        ...
        set_instance_policies_one_of_set_instance_policy_rotation_model = SetInstancePoliciesOneOfSetInstancePolicyRotation.from_dict(set_instance_policies_one_of_set_instance_policy_rotation_model_json)
        assert set_instance_policies_one_of_set_instance_policy_rotation_model != False

        # Construct a model instance of SetInstancePoliciesOneOfSetInstancePolicyRotation by calling from_dict on the json representation
        set_instance_policies_one_of_set_instance_policy_rotation_model_dict = SetInstancePoliciesOneOfSetInstancePolicyRotation.from_dict(set_instance_policies_one_of_set_instance_policy_rotation_model_json).__dict__
        set_instance_policies_one_of_set_instance_policy_rotation_model2 = SetInstancePoliciesOneOfSetInstancePolicyRotation(**set_instance_policies_one_of_set_instance_policy_rotation_model_dict)

        # Verify the model instances are equivalent
        assert set_instance_policies_one_of_set_instance_policy_rotation_model == set_instance_policies_one_of_set_instance_policy_rotation_model2

        # Convert model instance back to dict and verify no loss of data
        set_instance_policies_one_of_set_instance_policy_rotation_model_json2 = set_instance_policies_one_of_set_instance_policy_rotation_model.to_dict()
        assert set_instance_policies_one_of_set_instance_policy_rotation_model_json2 == set_instance_policies_one_of_set_instance_policy_rotation_model_json
...
class TestModel_SetInstancePoliciesOneOfSetMultipleInstancePolicies:
    ...
    def test_set_instance_policies_one_of_set_multiple_instance_policies_serialization(self):
        """
        ...
        set_multiple_instance_policies_resources_item_model['policy_data'] = set_multiple_instance_policies_resources_item_policy_data_model
        ...
        set_instance_policies_one_of_set_multiple_instance_policies_model_json['resources'] = [set_multiple_instance_policies_resources_item_model]
        ...
        set_instance_policies_one_of_set_multiple_instance_policies_model = SetInstancePoliciesOneOfSetMultipleInstancePolicies.from_dict(set_instance_policies_one_of_set_multiple_instance_policies_model_json)
        assert set_instance_policies_one_of_set_multiple_instance_policies_model != False

        # Construct a model instance of SetInstancePoliciesOneOfSetMultipleInstancePolicies by calling from_dict on the json representation
        set_instance_policies_one_of_set_multiple_instance_policies_model_dict = SetInstancePoliciesOneOfSetMultipleInstancePolicies.from_dict(set_instance_policies_one_of_set_multiple_instance_policies_model_json).__dict__
        set_instance_policies_one_of_set_multiple_instance_policies_model2 = SetInstancePoliciesOneOfSetMultipleInstancePolicies(**set_instance_policies_one_of_set_multiple_instance_policies_model_dict)

        # Verify the model instances are equivalent
        assert set_instance_policies_one_of_set_multiple_instance_policies_model == set_instance_policies_one_of_set_multiple_instance_policies_model2

        # Convert model instance back to dict and verify no loss of data
        set_instance_policies_one_of_set_multiple_instance_policies_model_json2 = set_instance_policies_one_of_set_multiple_instance_policies_model.to_dict()
        assert set_instance_policies_one_of_set_multiple_instance_policies_model_json2 == set_instance_policies_one_of_set_multiple_instance_policies_model_json
...
class TestModel_SetKeyPoliciesOneOfSetKeyPolicyDualAuthDelete:
    ...
    def test_set_key_policies_one_of_set_key_policy_dual_auth_delete_serialization(self):
        """
        ...
        set_key_policies_one_of_set_key_policy_dual_auth_delete_model_json['resources'] = [key_policy_dual_auth_delete_model]
        ...
        set_key_policies_one_of_set_key_policy_dual_auth_delete_model = SetKeyPoliciesOneOfSetKeyPolicyDualAuthDelete.from_dict(set_key_policies_one_of_set_key_policy_dual_auth_delete_model_json)
        assert set_key_policies_one_of_set_key_policy_dual_auth_delete_model != False

        # Construct a model instance of SetKeyPoliciesOneOfSetKeyPolicyDualAuthDelete by calling from_dict on the json representation
        set_key_policies_one_of_set_key_policy_dual_auth_delete_model_dict = SetKeyPoliciesOneOfSetKeyPolicyDualAuthDelete.from_dict(set_key_policies_one_of_set_key_policy_dual_auth_delete_model_json).__dict__
        set_key_policies_one_of_set_key_policy_dual_auth_delete_model2 = SetKeyPoliciesOneOfSetKeyPolicyDualAuthDelete(**set_key_policies_one_of_set_key_policy_dual_auth_delete_model_dict)

        # Verify the model instances are equivalent
        assert set_key_policies_one_of_set_key_policy_dual_auth_delete_model == set_key_policies_one_of_set_key_policy_dual_auth_delete_model2

        # Convert model instance back to dict and verify no loss of data
        set_key_policies_one_of_set_key_policy_dual_auth_delete_model_json2 = set_key_policies_one_of_set_key_policy_dual_auth_delete_model.to_dict()
        assert set_key_policies_one_of_set_key_policy_dual_auth_delete_model_json2 == set_key_policies_one_of_set_key_policy_dual_auth_delete_model_json
...
class TestModel_SetKeyPoliciesOneOfSetKeyPolicyRotation:
    ...
    def test_set_key_policies_one_of_set_key_policy_rotation_serialization(self):
        ...
        set_key_policies_one_of_set_key_policy_rotation_model = SetKeyPoliciesOneOfSetKeyPolicyRotation.from_dict(set_key_policies_one_of_set_key_policy_rotation_model_json)
        assert set_key_policies_one_of_set_key_policy_rotation_model != False

        # Construct a model instance of SetKeyPoliciesOneOfSetKeyPolicyRotation by calling from_dict on the json representation
        set_key_policies_one_of_set_key_policy_rotation_model_dict = SetKeyPoliciesOneOfSetKeyPolicyRotation.from_dict(set_key_policies_one_of_set_key_policy_rotation_model_json).__dict__
        set_key_policies_one_of_set_key_policy_rotation_model2 = SetKeyPoliciesOneOfSetKeyPolicyRotation(**set_key_policies_one_of_set_key_policy_rotation_model_dict)

        # Verify the model instances are equivalent
        assert set_key_policies_one_of_set_key_policy_rotation_model == set_key_policies_one_of_set_key_policy_rotation_model2

        # Convert model instance back to dict and verify no loss of data
        set_key_policies_one_of_set_key_policy_rotation_model_json2 = set_key_policies_one_of_set_key_policy_rotation_model.to_dict()
        assert set_key_policies_one_of_set_key_policy_rotation_model_json2 == set_key_policies_one_of_set_key_policy_rotation_model_json
...
class TestModel_SetKeyPoliciesOneOfSetMultipleKeyPolicies:
    ...
    def test_set_key_policies_one_of_set_multiple_key_policies_serialization(self):
        ...
        set_key_policies_one_of_set_multiple_key_policies_model_json['resources'] = [set_multiple_key_policies_resource_model]

        # Construct a model instance of SetKeyPoliciesOneOfSetMultipleKeyPolicies by calling from_dict on the json representation
        set_key_policies_one_of_set_multiple_key_policies_model = SetKeyPoliciesOneOfSetMultipleKeyPolicies.from_dict(set_key_policies_one_of_set_multiple_key_policies_model_json)
        assert set_key_policies_one_of_set_multiple_key_policies_model != False

        # Construct a model instance of SetKeyPoliciesOneOfSetMultipleKeyPolicies by calling from_dict on the json representation
        set_key_policies_one_of_set_multiple_key_policies_model_dict = SetKeyPoliciesOneOfSetMultipleKeyPolicies.from_dict(set_key_policies_one_of_set_multiple_key_policies_model_json).__dict__
        set_key_policies_one_of_set_multiple_key_policies_model2 = SetKeyPoliciesOneOfSetMultipleKeyPolicies(**set_key_policies_one_of_set_multiple_key_policies_model_dict)

        # Verify the model instances are equivalent
        assert set_key_policies_one_of_set_multiple_key_policies_model == set_key_policies_one_of_set_multiple_key_policies_model2

        # Convert model instance back to dict and verify no loss of data
        set_key_policies_one_of_set_multiple_key_policies_model_json2 = set_key_policies_one_of_set_multiple_key_policies_model.to_dict()
        assert set_key_policies_one_of_set_multiple_key_policies_model_json2 == set_key_policies_one_of_set_multiple_key_policies_model_json
